...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	5ef040ef          	jal	ra,ffffffffc0204e38 <memset>
...
ffffffffc0200056:	e3658593          	addi	a1,a1,-458 # ffffffffc0204e88 <etext+0x2>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e4e50513          	addi	a0,a0,-434 # ffffffffc0204ea8 <etext+0x22>
...
ffffffffc020007a:	5a4040ef          	jal	ra,ffffffffc020461e <proc_init>
...
ffffffffc020008e:	7de040ef          	jal	ra,ffffffffc020486c <cpu_idle>
...
ffffffffc02000ac:	e0850513          	addi	a0,a0,-504 # ffffffffc0204eb0 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	0c7040ef          	jal	ra,ffffffffc0204a3a <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	091040ef          	jal	ra,ffffffffc0204a3a <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	cee50513          	addi	a0,a0,-786 # ffffffffc0204eb8 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc02001e4:	cf850513          	addi	a0,a0,-776 # ffffffffc0204ed8 <etext+0x52>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	c9a58593          	addi	a1,a1,-870 # ffffffffc0204e86 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d0450513          	addi	a0,a0,-764 # ffffffffc0204ef8 <etext+0x72>
...
ffffffffc020020c:	d1050513          	addi	a0,a0,-752 # ffffffffc0204f18 <etext+0x92>
...
ffffffffc0200220:	d1c50513          	addi	a0,a0,-740 # ffffffffc0204f38 <etext+0xb2>
...
ffffffffc020024e:	d0e50513          	addi	a0,a0,-754 # ffffffffc0204f58 <etext+0xd2>
}
...
ffffffffc020025c:	d3060613          	addi	a2,a2,-720 # ffffffffc0204f88 <etext+0x102>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d3c50513          	addi	a0,a0,-708 # ffffffffc0204fa0 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc0200278:	d4460613          	addi	a2,a2,-700 # ffffffffc0204fb8 <etext+0x132>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d5c58593          	addi	a1,a1,-676 # ffffffffc0204fd8 <etext+0x152>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204fe0 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d5e60613          	addi	a2,a2,-674 # ffffffffc0204ff0 <etext+0x16a>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	d7e58593          	addi	a1,a1,-642 # ffffffffc0205018 <etext+0x192>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d3e50513          	addi	a0,a0,-706 # ffffffffc0204fe0 <etext+0x15a>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	d7a60613          	addi	a2,a2,-646 # ffffffffc0205028 <etext+0x1a2>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	d9258593          	addi	a1,a1,-622 # ffffffffc0205048 <etext+0x1c2>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d2250513          	addi	a0,a0,-734 # ffffffffc0204fe0 <etext+0x15a>
...
ffffffffc02002fc:	d6050513          	addi	a0,a0,-672 # ffffffffc0205058 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	d6650513          	addi	a0,a0,-666 # ffffffffc0205080 <etext+0x1fa>
...
ffffffffc0200340:	db4c0c13          	addi	s8,s8,-588 # ffffffffc02050f0 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	d6490913          	addi	s2,s2,-668 # ffffffffc02050a8 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	d6448493          	addi	s1,s1,-668 # ffffffffc02050b0 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	d62b0b13          	addi	s6,s6,-670 # ffffffffc02050b8 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	c7aa0a13          	addi	s4,s4,-902 # ffffffffc0204fd8 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	d70d0d13          	addi	s10,s10,-656 # ffffffffc02050f0 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	277040ef          	jal	ra,ffffffffc0204e04 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	263040ef          	jal	ra,ffffffffc0204e04 <strcmp>
...
ffffffffc02003e0:	243040ef          	jal	ra,ffffffffc0204e22 <strchr>
...
ffffffffc020041e:	205040ef          	jal	ra,ffffffffc0204e22 <strchr>
...
ffffffffc020043c:	ca050513          	addi	a0,a0,-864 # ffffffffc02050d8 <etext+0x252>
...
ffffffffc0200478:	cc450513          	addi	a0,a0,-828 # ffffffffc0205138 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c1e50513          	addi	a0,a0,-994 # ffffffffc02060a8 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	c9050513          	addi	a0,a0,-880 # ffffffffc0205158 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	0bf040ef          	jal	ra,ffffffffc0204e4a <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	09b040ef          	jal	ra,ffffffffc0204e4a <memcpy>
    return 0;
}
...
ffffffffc02005fe:	b7e50513          	addi	a0,a0,-1154 # ffffffffc0205178 <commands+0x88>
...
ffffffffc0200626:	b7660613          	addi	a2,a2,-1162 # ffffffffc0205198 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	b8250513          	addi	a0,a0,-1150 # ffffffffc02051b0 <commands+0xc0>
...
ffffffffc0200660:	b6c50513          	addi	a0,a0,-1172 # ffffffffc02051c8 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	b7450513          	addi	a0,a0,-1164 # ffffffffc02051e0 <commands+0xf0>
...
ffffffffc020067e:	b7e50513          	addi	a0,a0,-1154 # ffffffffc02051f8 <commands+0x108>
...
ffffffffc020068c:	b8850513          	addi	a0,a0,-1144 # ffffffffc0205210 <commands+0x120>
...
ffffffffc020069a:	b9250513          	addi	a0,a0,-1134 # ffffffffc0205228 <commands+0x138>
...
ffffffffc02006a8:	b9c50513          	addi	a0,a0,-1124 # ffffffffc0205240 <commands+0x150>
...
ffffffffc02006b6:	ba650513          	addi	a0,a0,-1114 # ffffffffc0205258 <commands+0x168>
...
ffffffffc02006c4:	bb050513          	addi	a0,a0,-1104 # ffffffffc0205270 <commands+0x180>
...
ffffffffc02006d2:	bba50513          	addi	a0,a0,-1094 # ffffffffc0205288 <commands+0x198>
...
ffffffffc02006e0:	bc450513          	addi	a0,a0,-1084 # ffffffffc02052a0 <commands+0x1b0>
...
ffffffffc02006ee:	bce50513          	addi	a0,a0,-1074 # ffffffffc02052b8 <commands+0x1c8>
...
ffffffffc02006fc:	bd850513          	addi	a0,a0,-1064 # ffffffffc02052d0 <commands+0x1e0>
...
ffffffffc020070a:	be250513          	addi	a0,a0,-1054 # ffffffffc02052e8 <commands+0x1f8>
...
ffffffffc0200718:	bec50513          	addi	a0,a0,-1044 # ffffffffc0205300 <commands+0x210>
...
ffffffffc0200726:	bf650513          	addi	a0,a0,-1034 # ffffffffc0205318 <commands+0x228>
...
ffffffffc0200734:	c0050513          	addi	a0,a0,-1024 # ffffffffc0205330 <commands+0x240>
...
ffffffffc0200742:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0205348 <commands+0x258>
...
ffffffffc0200750:	c1450513          	addi	a0,a0,-1004 # ffffffffc0205360 <commands+0x270>
...
ffffffffc020075e:	c1e50513          	addi	a0,a0,-994 # ffffffffc0205378 <commands+0x288>
...
ffffffffc020076c:	c2850513          	addi	a0,a0,-984 # ffffffffc0205390 <commands+0x2a0>
...
ffffffffc020077a:	c3250513          	addi	a0,a0,-974 # ffffffffc02053a8 <commands+0x2b8>
...
ffffffffc0200788:	c3c50513          	addi	a0,a0,-964 # ffffffffc02053c0 <commands+0x2d0>
...
ffffffffc0200796:	c4650513          	addi	a0,a0,-954 # ffffffffc02053d8 <commands+0x2e8>
...
ffffffffc02007a4:	c5050513          	addi	a0,a0,-944 # ffffffffc02053f0 <commands+0x300>
...
ffffffffc02007b2:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205408 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	c6450513          	addi	a0,a0,-924 # ffffffffc0205420 <commands+0x330>
...
ffffffffc02007ce:	c6e50513          	addi	a0,a0,-914 # ffffffffc0205438 <commands+0x348>
...
ffffffffc02007dc:	c7850513          	addi	a0,a0,-904 # ffffffffc0205450 <commands+0x360>
...
ffffffffc02007ea:	c8250513          	addi	a0,a0,-894 # ffffffffc0205468 <commands+0x378>
...
ffffffffc02007f8:	c8c50513          	addi	a0,a0,-884 # ffffffffc0205480 <commands+0x390>
...
ffffffffc0200806:	c9650513          	addi	a0,a0,-874 # ffffffffc0205498 <commands+0x3a8>
...
ffffffffc0200818:	c9c50513          	addi	a0,a0,-868 # ffffffffc02054b0 <commands+0x3c0>
}
...
ffffffffc020082c:	ca050513          	addi	a0,a0,-864 # ffffffffc02054c8 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	ca050513          	addi	a0,a0,-864 # ffffffffc02054e0 <commands+0x3f0>
...
ffffffffc0200854:	ca850513          	addi	a0,a0,-856 # ffffffffc02054f8 <commands+0x408>
...
ffffffffc0200864:	cb050513          	addi	a0,a0,-848 # ffffffffc0205510 <commands+0x420>
...
ffffffffc0200878:	cb450513          	addi	a0,a0,-844 # ffffffffc0205528 <commands+0x438>
}
...
ffffffffc0200894:	d6070713          	addi	a4,a4,-672 # ffffffffc02055f0 <commands+0x500>
...
ffffffffc02008a6:	cfe50513          	addi	a0,a0,-770 # ffffffffc02055a0 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	cd250513          	addi	a0,a0,-814 # ffffffffc0205580 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	c8650513          	addi	a0,a0,-890 # ffffffffc0205540 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	c9a50513          	addi	a0,a0,-870 # ffffffffc0205560 <commands+0x470>
...
ffffffffc02008fc:	cd850513          	addi	a0,a0,-808 # ffffffffc02055d0 <commands+0x4e0>
...
ffffffffc0200910:	cb450513          	addi	a0,a0,-844 # ffffffffc02055c0 <commands+0x4d0>
}
...
ffffffffc0200932:	eaa70713          	addi	a4,a4,-342 # ffffffffc02057d8 <commands+0x6e8>
...
ffffffffc0200944:	e8050513          	addi	a0,a0,-384 # ffffffffc02057c0 <commands+0x6d0>
...
ffffffffc0200966:	cbe50513          	addi	a0,a0,-834 # ffffffffc0205620 <commands+0x530>
}
...
ffffffffc02009c0:	d0460613          	addi	a2,a2,-764 # ffffffffc02056c0 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00004517          	auipc	a0,0x4
ffffffffc02009cc:	7e850513          	addi	a0,a0,2024 # ffffffffc02051b0 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d0c50513          	addi	a0,a0,-756 # ffffffffc02056e0 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d1a50513          	addi	a0,a0,-742 # ffffffffc02056f8 <commands+0x608>
...
ffffffffc0200a6a:	c5a60613          	addi	a2,a2,-934 # ffffffffc02056c0 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	73e50513          	addi	a0,a0,1854 # ffffffffc02051b0 <commands+0xc0>
...
ffffffffc0200a96:	c2e60613          	addi	a2,a2,-978 # ffffffffc02056c0 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	71250513          	addi	a0,a0,1810 # ffffffffc02051b0 <commands+0xc0>
...
ffffffffc0200c2e:	33e63603          	ld	a2,830(a2) # ffffffffc0206f68 <nbase>
...
ffffffffc0200e74:	9a868693          	addi	a3,a3,-1624 # ffffffffc0205818 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	9b060613          	addi	a2,a2,-1616 # ffffffffc0205828 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0205840 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	a4868693          	addi	a3,a3,-1464 # ffffffffc02058d8 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	99060613          	addi	a2,a2,-1648 # ffffffffc0205828 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	99c50513          	addi	a0,a0,-1636 # ffffffffc0205840 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	a5068693          	addi	a3,a3,-1456 # ffffffffc0205900 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	97060613          	addi	a2,a2,-1680 # ffffffffc0205828 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	97c50513          	addi	a0,a0,-1668 # ffffffffc0205840 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205940 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	95060613          	addi	a2,a2,-1712 # ffffffffc0205828 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	95c50513          	addi	a0,a0,-1700 # ffffffffc0205840 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	ad868693          	addi	a3,a3,-1320 # ffffffffc02059c8 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	93060613          	addi	a2,a2,-1744 # ffffffffc0205828 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	93c50513          	addi	a0,a0,-1732 # ffffffffc0205840 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	96868693          	addi	a3,a3,-1688 # ffffffffc0205878 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	91060613          	addi	a2,a2,-1776 # ffffffffc0205828 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	91c50513          	addi	a0,a0,-1764 # ffffffffc0205840 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	a8868693          	addi	a3,a3,-1400 # ffffffffc02059b8 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	8f060613          	addi	a2,a2,-1808 # ffffffffc0205828 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	8fc50513          	addi	a0,a0,-1796 # ffffffffc0205840 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	a5068693          	addi	a3,a3,-1456 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	8d060613          	addi	a2,a2,-1840 # ffffffffc0205828 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	8dc50513          	addi	a0,a0,-1828 # ffffffffc0205840 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a1068693          	addi	a3,a3,-1520 # ffffffffc0205980 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	8b060613          	addi	a2,a2,-1872 # ffffffffc0205828 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	8bc50513          	addi	a0,a0,-1860 # ffffffffc0205840 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	a8068693          	addi	a3,a3,-1408 # ffffffffc0205a10 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	89060613          	addi	a2,a2,-1904 # ffffffffc0205828 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	89c50513          	addi	a0,a0,-1892 # ffffffffc0205840 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	a5068693          	addi	a3,a3,-1456 # ffffffffc0205a00 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	87060613          	addi	a2,a2,-1936 # ffffffffc0205828 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	87c50513          	addi	a0,a0,-1924 # ffffffffc0205840 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	9d068693          	addi	a3,a3,-1584 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	85060613          	addi	a2,a2,-1968 # ffffffffc0205828 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	85c50513          	addi	a0,a0,-1956 # ffffffffc0205840 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	9f068693          	addi	a3,a3,-1552 # ffffffffc02059e0 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	83060613          	addi	a2,a2,-2000 # ffffffffc0205828 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	83c50513          	addi	a0,a0,-1988 # ffffffffc0205840 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	86868693          	addi	a3,a3,-1944 # ffffffffc0205878 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	81060613          	addi	a2,a2,-2032 # ffffffffc0205828 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	81c50513          	addi	a0,a0,-2020 # ffffffffc0205840 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	97068693          	addi	a3,a3,-1680 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc0201038:	00004617          	auipc	a2,0x4
ffffffffc020103c:	7f060613          	addi	a2,a2,2032 # ffffffffc0205828 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00004517          	auipc	a0,0x4
ffffffffc0201048:	7fc50513          	addi	a0,a0,2044 # ffffffffc0205840 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	86868693          	addi	a3,a3,-1944 # ffffffffc02058b8 <commands+0x7c8>
ffffffffc0201058:	00004617          	auipc	a2,0x4
ffffffffc020105c:	7d060613          	addi	a2,a2,2000 # ffffffffc0205828 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00004517          	auipc	a0,0x4
ffffffffc0201068:	7dc50513          	addi	a0,a0,2012 # ffffffffc0205840 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	82868693          	addi	a3,a3,-2008 # ffffffffc0205898 <commands+0x7a8>
ffffffffc0201078:	00004617          	auipc	a2,0x4
ffffffffc020107c:	7b060613          	addi	a2,a2,1968 # ffffffffc0205828 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00004517          	auipc	a0,0x4
ffffffffc0201088:	7bc50513          	addi	a0,a0,1980 # ffffffffc0205840 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	82868693          	addi	a3,a3,-2008 # ffffffffc02058b8 <commands+0x7c8>
ffffffffc0201098:	00004617          	auipc	a2,0x4
ffffffffc020109c:	79060613          	addi	a2,a2,1936 # ffffffffc0205828 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00004517          	auipc	a0,0x4
ffffffffc02010a8:	79c50513          	addi	a0,a0,1948 # ffffffffc0205840 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	ab068693          	addi	a3,a3,-1360 # ffffffffc0205b60 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	77060613          	addi	a2,a2,1904 # ffffffffc0205828 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	77c50513          	addi	a0,a0,1916 # ffffffffc0205840 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	93068693          	addi	a3,a3,-1744 # ffffffffc0205a00 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	75060613          	addi	a2,a2,1872 # ffffffffc0205828 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	75c50513          	addi	a0,a0,1884 # ffffffffc0205840 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	8b068693          	addi	a3,a3,-1872 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	73060613          	addi	a2,a2,1840 # ffffffffc0205828 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	73c50513          	addi	a0,a0,1852 # ffffffffc0205840 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	85068693          	addi	a3,a3,-1968 # ffffffffc0205960 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	71060613          	addi	a2,a2,1808 # ffffffffc0205828 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	71c50513          	addi	a0,a0,1820 # ffffffffc0205840 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	9f068693          	addi	a3,a3,-1552 # ffffffffc0205b20 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	6f060613          	addi	a2,a2,1776 # ffffffffc0205828 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	6fc50513          	addi	a0,a0,1788 # ffffffffc0205840 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	9b068693          	addi	a3,a3,-1616 # ffffffffc0205b00 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	6d060613          	addi	a2,a2,1744 # ffffffffc0205828 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	6dc50513          	addi	a0,a0,1756 # ffffffffc0205840 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	96868693          	addi	a3,a3,-1688 # ffffffffc0205ad8 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	6b060613          	addi	a2,a2,1712 # ffffffffc0205828 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205840 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	92068693          	addi	a3,a3,-1760 # ffffffffc0205ab0 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	69060613          	addi	a2,a2,1680 # ffffffffc0205828 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	69c50513          	addi	a0,a0,1692 # ffffffffc0205840 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205aa0 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	67060613          	addi	a2,a2,1648 # ffffffffc0205828 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	67c50513          	addi	a0,a0,1660 # ffffffffc0205840 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00004697          	auipc	a3,0x4
ffffffffc02011d4:	7d068693          	addi	a3,a3,2000 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	65060613          	addi	a2,a2,1616 # ffffffffc0205828 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	65c50513          	addi	a0,a0,1628 # ffffffffc0205840 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	89068693          	addi	a3,a3,-1904 # ffffffffc0205a80 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	63060613          	addi	a2,a2,1584 # ffffffffc0205828 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	63c50513          	addi	a0,a0,1596 # ffffffffc0205840 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	84068693          	addi	a3,a3,-1984 # ffffffffc0205a50 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	61060613          	addi	a2,a2,1552 # ffffffffc0205828 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	61c50513          	addi	a0,a0,1564 # ffffffffc0205840 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	80868693          	addi	a3,a3,-2040 # ffffffffc0205a38 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	5f060613          	addi	a2,a2,1520 # ffffffffc0205828 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205840 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	75068693          	addi	a3,a3,1872 # ffffffffc02059a0 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	5d060613          	addi	a2,a2,1488 # ffffffffc0205828 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	5dc50513          	addi	a0,a0,1500 # ffffffffc0205840 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00004697          	auipc	a3,0x4
ffffffffc0201274:	7b068693          	addi	a3,a3,1968 # ffffffffc0205a20 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	5b060613          	addi	a2,a2,1456 # ffffffffc0205828 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205840 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205b40 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	59060613          	addi	a2,a2,1424 # ffffffffc0205828 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	59c50513          	addi	a0,a0,1436 # ffffffffc0205840 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205b70 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	57060613          	addi	a2,a2,1392 # ffffffffc0205828 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	57c50513          	addi	a0,a0,1404 # ffffffffc0205840 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	58868693          	addi	a3,a3,1416 # ffffffffc0205858 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	55060613          	addi	a2,a2,1360 # ffffffffc0205828 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	55c50513          	addi	a0,a0,1372 # ffffffffc0205840 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	5a868693          	addi	a3,a3,1448 # ffffffffc0205898 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	53060613          	addi	a2,a2,1328 # ffffffffc0205828 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	53c50513          	addi	a0,a0,1340 # ffffffffc0205840 <commands+0x750>
...
ffffffffc0201440:	74c68693          	addi	a3,a3,1868 # ffffffffc0205b88 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	3e460613          	addi	a2,a2,996 # ffffffffc0205828 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	3f050513          	addi	a0,a0,1008 # ffffffffc0205840 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	72468693          	addi	a3,a3,1828 # ffffffffc0205b80 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	3c460613          	addi	a2,a2,964 # ffffffffc0205828 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	3d050513          	addi	a0,a0,976 # ffffffffc0205840 <commands+0x750>
...
ffffffffc0201512:	67268693          	addi	a3,a3,1650 # ffffffffc0205b80 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	31260613          	addi	a2,a2,786 # ffffffffc0205828 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	31e50513          	addi	a0,a0,798 # ffffffffc0205840 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	5d068693          	addi	a3,a3,1488 # ffffffffc0205bb0 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	24060613          	addi	a2,a2,576 # ffffffffc0205828 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	24c50513          	addi	a0,a0,588 # ffffffffc0205840 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	58068693          	addi	a3,a3,1408 # ffffffffc0205b80 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	22060613          	addi	a2,a2,544 # ffffffffc0205828 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	22c50513          	addi	a0,a0,556 # ffffffffc0205840 <commands+0x750>
...
ffffffffc02016f4:	8786b683          	ld	a3,-1928(a3) # ffffffffc0206f68 <nbase>
...
ffffffffc0201724:	4f060613          	addi	a2,a2,1264 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	50c50513          	addi	a0,a0,1292 # ffffffffc0205c38 <default_pmm_manager+0x60>
...
ffffffffc0201812:	43a68693          	addi	a3,a3,1082 # ffffffffc0205c48 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	01260613          	addi	a2,a2,18 # ffffffffc0205828 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	44650513          	addi	a0,a0,1094 # ffffffffc0205c68 <default_pmm_manager+0x90>
...
ffffffffc0201834:	45050513          	addi	a0,a0,1104 # ffffffffc0205c80 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	45850513          	addi	a0,a0,1112 # ffffffffc0205c98 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	60453503          	ld	a0,1540(a0) # ffffffffc0206f68 <nbase>
...
ffffffffc02019c6:	31e60613          	addi	a2,a2,798 # ffffffffc0205ce0 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	26a50513          	addi	a0,a0,618 # ffffffffc0205c38 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	2dc60613          	addi	a2,a2,732 # ffffffffc0205cb8 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	25050513          	addi	a0,a0,592 # ffffffffc0205c38 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	2ea60613          	addi	a2,a2,746 # ffffffffc0205ce0 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	23650513          	addi	a0,a0,566 # ffffffffc0205c38 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	2ee60613          	addi	a2,a2,750 # ffffffffc0205d00 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	21a50513          	addi	a0,a0,538 # ffffffffc0205c38 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	27a030ef          	jal	ra,ffffffffc0204e38 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	1e8030ef          	jal	ra,ffffffffc0204e38 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	f6a60613          	addi	a2,a2,-150 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	07650513          	addi	a0,a0,118 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	f5260613          	addi	a2,a2,-174 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	05e50513          	addi	a0,a0,94 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	f3860613          	addi	a2,a2,-200 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	04450513          	addi	a0,a0,68 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	02a50513          	addi	a0,a0,42 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	ce878793          	addi	a5,a5,-792 # ffffffffc0205bd8 <default_pmm_manager>
...
ffffffffc0201f02:	e3a50513          	addi	a0,a0,-454 # ffffffffc0205d38 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e0450513          	addi	a0,a0,-508 # ffffffffc0205d50 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	dfc50513          	addi	a0,a0,-516 # ffffffffc0205d68 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	dbc50513          	addi	a0,a0,-580 # ffffffffc0205d90 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	db850513          	addi	a0,a0,-584 # ffffffffc0205da8 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e0050513          	addi	a0,a0,-512 # ffffffffc0206090 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	e8258593          	addi	a1,a1,-382 # ffffffffc02061c8 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	2a1020ef          	jal	ra,ffffffffc0204df2 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2a7020ef          	jal	ra,ffffffffc0204e04 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	229020ef          	jal	ra,ffffffffc0204dbc <strlen>
...
ffffffffc0202458:	dec50513          	addi	a0,a0,-532 # ffffffffc0206240 <default_pmm_manager+0x668>
...
ffffffffc0202572:	b8268693          	addi	a3,a3,-1150 # ffffffffc02060f0 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	2b260613          	addi	a2,a2,690 # ffffffffc0205828 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00003517          	auipc	a0,0x3
ffffffffc0202586:	7a650513          	addi	a0,a0,1958 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	b2268693          	addi	a3,a3,-1246 # ffffffffc02060b0 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	29260613          	addi	a2,a2,658 # ffffffffc0205828 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00003517          	auipc	a0,0x3
ffffffffc02025a6:	78650513          	addi	a0,a0,1926 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	66060613          	addi	a2,a2,1632 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	76c50513          	addi	a0,a0,1900 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	6ec60613          	addi	a2,a2,1772 # ffffffffc0205cb8 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	75050513          	addi	a0,a0,1872 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	6d460613          	addi	a2,a2,1748 # ffffffffc0205cb8 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	73850513          	addi	a0,a0,1848 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00003697          	auipc	a3,0x3
ffffffffc0202600:	7ec68693          	addi	a3,a3,2028 # ffffffffc0205de8 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	22460613          	addi	a2,a2,548 # ffffffffc0205828 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	71850513          	addi	a0,a0,1816 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00003697          	auipc	a3,0x3
ffffffffc0202620:	7ac68693          	addi	a3,a3,1964 # ffffffffc0205dc8 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	20460613          	addi	a2,a2,516 # ffffffffc0205828 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	6f850513          	addi	a0,a0,1784 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0202644:	83868693          	addi	a3,a3,-1992 # ffffffffc0205e78 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	1e060613          	addi	a2,a2,480 # ffffffffc0205828 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	6d450513          	addi	a0,a0,1748 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00003697          	auipc	a3,0x3
ffffffffc0202664:	7e868693          	addi	a3,a3,2024 # ffffffffc0205e48 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	1c060613          	addi	a2,a2,448 # ffffffffc0205828 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	6b450513          	addi	a0,a0,1716 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00003697          	auipc	a3,0x3
ffffffffc0202684:	7a068693          	addi	a3,a3,1952 # ffffffffc0205e20 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	1a060613          	addi	a2,a2,416 # ffffffffc0205828 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	69450513          	addi	a0,a0,1684 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	86068693          	addi	a3,a3,-1952 # ffffffffc0205f00 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	18060613          	addi	a2,a2,384 # ffffffffc0205828 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	67450513          	addi	a0,a0,1652 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205fa0 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	16060613          	addi	a2,a2,352 # ffffffffc0205828 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	65450513          	addi	a0,a0,1620 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00003697          	auipc	a3,0x3
ffffffffc02026e4:	7f868693          	addi	a3,a3,2040 # ffffffffc0205ed8 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	14060613          	addi	a2,a2,320 # ffffffffc0205828 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	63450513          	addi	a0,a0,1588 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0202706:	50e60613          	addi	a2,a2,1294 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	61a50513          	addi	a0,a0,1562 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	81e68693          	addi	a3,a3,-2018 # ffffffffc0205f38 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	10660613          	addi	a2,a2,262 # ffffffffc0205828 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	5fa50513          	addi	a0,a0,1530 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	8c668693          	addi	a3,a3,-1850 # ffffffffc0206000 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	0e660613          	addi	a2,a2,230 # ffffffffc0205828 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	5da50513          	addi	a0,a0,1498 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	88e68693          	addi	a3,a3,-1906 # ffffffffc0205fe8 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	0c660613          	addi	a2,a2,198 # ffffffffc0205828 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	5ba50513          	addi	a0,a0,1466 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	83e68693          	addi	a3,a3,-1986 # ffffffffc0205fb8 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	0a660613          	addi	a2,a2,166 # ffffffffc0205828 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	59a50513          	addi	a0,a0,1434 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	9d668693          	addi	a3,a3,-1578 # ffffffffc0206170 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	08660613          	addi	a2,a2,134 # ffffffffc0205828 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	57a50513          	addi	a0,a0,1402 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00003697          	auipc	a3,0x3
ffffffffc02027be:	7ce68693          	addi	a3,a3,1998 # ffffffffc0205f88 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	06660613          	addi	a2,a2,102 # ffffffffc0205828 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	55a50513          	addi	a0,a0,1370 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00003697          	auipc	a3,0x3
ffffffffc02027de:	79e68693          	addi	a3,a3,1950 # ffffffffc0205f78 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	04660613          	addi	a2,a2,70 # ffffffffc0205828 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	53a50513          	addi	a0,a0,1338 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	87668693          	addi	a3,a3,-1930 # ffffffffc0206070 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	02660613          	addi	a2,a2,38 # ffffffffc0205828 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	51a50513          	addi	a0,a0,1306 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	74e68693          	addi	a3,a3,1870 # ffffffffc0205f68 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	00660613          	addi	a2,a2,6 # ffffffffc0205828 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	68668693          	addi	a3,a3,1670 # ffffffffc0205ec0 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	fe660613          	addi	a2,a2,-26 # ffffffffc0205828 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	4da50513          	addi	a0,a0,1242 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00003697          	auipc	a3,0x3
ffffffffc020285e:	7be68693          	addi	a3,a3,1982 # ffffffffc0206018 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	fc660613          	addi	a2,a2,-58 # ffffffffc0205828 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	62e68693          	addi	a3,a3,1582 # ffffffffc0205ea8 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	fa660613          	addi	a2,a2,-90 # ffffffffc0205828 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	49a50513          	addi	a0,a0,1178 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	37660613          	addi	a2,a2,886 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	39250513          	addi	a0,a0,914 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00003697          	auipc	a3,0x3
ffffffffc02028b6:	79668693          	addi	a3,a3,1942 # ffffffffc0206048 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	f6e60613          	addi	a2,a2,-146 # ffffffffc0205828 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	46250513          	addi	a0,a0,1122 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	72e68693          	addi	a3,a3,1838 # ffffffffc0206000 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	f4e60613          	addi	a2,a2,-178 # ffffffffc0205828 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	44250513          	addi	a0,a0,1090 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	73e68693          	addi	a3,a3,1854 # ffffffffc0206030 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	f2e60613          	addi	a2,a2,-210 # ffffffffc0205828 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	42250513          	addi	a0,a0,1058 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	6ee68693          	addi	a3,a3,1774 # ffffffffc0206000 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f0e60613          	addi	a2,a2,-242 # ffffffffc0205828 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	40250513          	addi	a0,a0,1026 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	82668693          	addi	a3,a3,-2010 # ffffffffc0206158 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	eee60613          	addi	a2,a2,-274 # ffffffffc0205828 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	3e250513          	addi	a0,a0,994 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00003697          	auipc	a3,0x3
ffffffffc0202956:	7ce68693          	addi	a3,a3,1998 # ffffffffc0206120 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	ece60613          	addi	a2,a2,-306 # ffffffffc0205828 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	3c250513          	addi	a0,a0,962 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00003697          	auipc	a3,0x3
ffffffffc0202976:	79668693          	addi	a3,a3,1942 # ffffffffc0206108 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	eae60613          	addi	a2,a2,-338 # ffffffffc0205828 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	3a250513          	addi	a0,a0,930 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	6de68693          	addi	a3,a3,1758 # ffffffffc0206070 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	e8e60613          	addi	a2,a2,-370 # ffffffffc0205828 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	38250513          	addi	a0,a0,898 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	4f668693          	addi	a3,a3,1270 # ffffffffc0205ea8 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	e6e60613          	addi	a2,a2,-402 # ffffffffc0205828 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	36250513          	addi	a0,a0,866 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	23e60613          	addi	a2,a2,574 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	34a50513          	addi	a0,a0,842 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	4d668693          	addi	a3,a3,1238 # ffffffffc0205ec0 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	e3660613          	addi	a2,a2,-458 # ffffffffc0205828 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	32a50513          	addi	a0,a0,810 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	52e68693          	addi	a3,a3,1326 # ffffffffc0205f38 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e1660613          	addi	a2,a2,-490 # ffffffffc0205828 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	30a50513          	addi	a0,a0,778 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00003697          	auipc	a3,0x3
ffffffffc0202a2e:	7ee68693          	addi	a3,a3,2030 # ffffffffc0206218 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	df660613          	addi	a2,a2,-522 # ffffffffc0205828 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	2ea50513          	addi	a0,a0,746 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00003697          	auipc	a3,0x3
ffffffffc0202a4e:	79668693          	addi	a3,a3,1942 # ffffffffc02061e0 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	dd660613          	addi	a2,a2,-554 # ffffffffc0205828 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	2ca50513          	addi	a0,a0,714 # ffffffffc0205d28 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	74668693          	addi	a3,a3,1862 # ffffffffc02061b0 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	db660613          	addi	a2,a2,-586 # ffffffffc0205828 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	2aa50513          	addi	a0,a0,682 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	77068693          	addi	a3,a3,1904 # ffffffffc0206260 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	d3060613          	addi	a2,a2,-720 # ffffffffc0205828 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	22450513          	addi	a0,a0,548 # ffffffffc0205d28 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	19660613          	addi	a2,a2,406 # ffffffffc0205ce0 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	0e250513          	addi	a0,a0,226 # ffffffffc0205c38 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	6ce50513          	addi	a0,a0,1742 # ffffffffc02062a8 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	69450513          	addi	a0,a0,1684 # ffffffffc02062c0 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	6b050513          	addi	a0,a0,1712 # ffffffffc0206330 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	6e450513          	addi	a0,a0,1764 # ffffffffc0206380 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	6f850513          	addi	a0,a0,1784 # ffffffffc0206408 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	14060613          	addi	a2,a2,320 # ffffffffc0206f68 <nbase>
...
ffffffffc0202e58:	65c50513          	addi	a0,a0,1628 # ffffffffc02064b0 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	5d850513          	addi	a0,a0,1496 # ffffffffc0206500 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	8de68693          	addi	a3,a3,-1826 # ffffffffc0205818 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	8e660613          	addi	a2,a2,-1818 # ffffffffc0205828 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	34a50513          	addi	a0,a0,842 # ffffffffc0206298 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	d8260613          	addi	a2,a2,-638 # ffffffffc0205ce0 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	cce50513          	addi	a0,a0,-818 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	51268693          	addi	a3,a3,1298 # ffffffffc0206488 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	8aa60613          	addi	a2,a2,-1878 # ffffffffc0205828 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	30e50513          	addi	a0,a0,782 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	41268693          	addi	a3,a3,1042 # ffffffffc02063a8 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	88a60613          	addi	a2,a2,-1910 # ffffffffc0205828 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	2ee50513          	addi	a0,a0,750 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	2c260613          	addi	a2,a2,706 # ffffffffc0206278 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	2d650513          	addi	a0,a0,726 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	4a268693          	addi	a3,a3,1186 # ffffffffc0206470 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	85260613          	addi	a2,a2,-1966 # ffffffffc0205828 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	2b650513          	addi	a0,a0,694 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d1260613          	addi	a2,a2,-750 # ffffffffc0205d00 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	c3e50513          	addi	a0,a0,-962 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	3ba68693          	addi	a3,a3,954 # ffffffffc02063c0 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	81a60613          	addi	a2,a2,-2022 # ffffffffc0205828 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	27e50513          	addi	a0,a0,638 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	2d268693          	addi	a3,a3,722 # ffffffffc02062f8 <default_pmm_manager+0x720>
ffffffffc020302e:	00002617          	auipc	a2,0x2
ffffffffc0203032:	7fa60613          	addi	a2,a2,2042 # ffffffffc0205828 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	25e50513          	addi	a0,a0,606 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	81268693          	addi	a3,a3,-2030 # ffffffffc0205858 <commands+0x768>
ffffffffc020304e:	00002617          	auipc	a2,0x2
ffffffffc0203052:	7da60613          	addi	a2,a2,2010 # ffffffffc0205828 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	23e50513          	addi	a0,a0,574 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	99a68693          	addi	a3,a3,-1638 # ffffffffc0205a00 <commands+0x910>
ffffffffc020306e:	00002617          	auipc	a2,0x2
ffffffffc0203072:	7ba60613          	addi	a2,a2,1978 # ffffffffc0205828 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	21e50513          	addi	a0,a0,542 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	28a68693          	addi	a3,a3,650 # ffffffffc0206310 <default_pmm_manager+0x738>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	79a60613          	addi	a2,a2,1946 # ffffffffc0205828 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	1fe50513          	addi	a0,a0,510 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	24268693          	addi	a3,a3,578 # ffffffffc02062e8 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	77a60613          	addi	a2,a2,1914 # ffffffffc0205828 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	1de50513          	addi	a0,a0,478 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	42a68693          	addi	a3,a3,1066 # ffffffffc02064f0 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	75a60613          	addi	a2,a2,1882 # ffffffffc0205828 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	1be50513          	addi	a0,a0,446 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	b2a60613          	addi	a2,a2,-1238 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	b4650513          	addi	a0,a0,-1210 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	3e268693          	addi	a3,a3,994 # ffffffffc02064e0 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	72260613          	addi	a2,a2,1826 # ffffffffc0205828 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	18650513          	addi	a0,a0,390 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	31268693          	addi	a3,a3,786 # ffffffffc0206430 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	70260613          	addi	a2,a2,1794 # ffffffffc0205828 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	16650513          	addi	a0,a0,358 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	2a268693          	addi	a3,a3,674 # ffffffffc02063e0 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	6e260613          	addi	a2,a2,1762 # ffffffffc0205828 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	14650513          	addi	a0,a0,326 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	20a68693          	addi	a3,a3,522 # ffffffffc0206368 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	6c260613          	addi	a2,a2,1730 # ffffffffc0205828 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	12650513          	addi	a0,a0,294 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	35a68693          	addi	a3,a3,858 # ffffffffc02064d8 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	6a260613          	addi	a2,a2,1698 # ffffffffc0205828 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	10650513          	addi	a0,a0,262 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	18268693          	addi	a3,a3,386 # ffffffffc0206320 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	68260613          	addi	a2,a2,1666 # ffffffffc0205828 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	0e650513          	addi	a0,a0,230 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	2a268693          	addi	a3,a3,674 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	66260613          	addi	a2,a2,1634 # ffffffffc0205828 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	0c650513          	addi	a0,a0,198 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	28268693          	addi	a3,a3,642 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	64260613          	addi	a2,a2,1602 # ffffffffc0205828 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	0a650513          	addi	a0,a0,166 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	24268693          	addi	a3,a3,578 # ffffffffc0206440 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	62260613          	addi	a2,a2,1570 # ffffffffc0205828 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	08650513          	addi	a0,a0,134 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	22268693          	addi	a3,a3,546 # ffffffffc0206440 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	60260613          	addi	a2,a2,1538 # ffffffffc0205828 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	06650513          	addi	a0,a0,102 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	21268693          	addi	a3,a3,530 # ffffffffc0206450 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	5e260613          	addi	a2,a2,1506 # ffffffffc0205828 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	04650513          	addi	a0,a0,70 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	1f268693          	addi	a3,a3,498 # ffffffffc0206450 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	5c260613          	addi	a2,a2,1474 # ffffffffc0205828 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	02650513          	addi	a0,a0,38 # ffffffffc0206298 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	1b268693          	addi	a3,a3,434 # ffffffffc0206430 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	5a260613          	addi	a2,a2,1442 # ffffffffc0205828 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	00650513          	addi	a0,a0,6 # ffffffffc0206298 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	2a2b0b13          	addi	s6,s6,674 # ffffffffc0206580 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	282b8b93          	addi	s7,s7,642 # ffffffffc0206568 <default_pmm_manager+0x990>
...
ffffffffc020339c:	18850513          	addi	a0,a0,392 # ffffffffc0206520 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	1a668693          	addi	a3,a3,422 # ffffffffc0206550 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	47660613          	addi	a2,a2,1142 # ffffffffc0205828 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	eda50513          	addi	a0,a0,-294 # ffffffffc0206298 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	1ce50513          	addi	a0,a0,462 # ffffffffc02065d0 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	19c68693          	addi	a3,a3,412 # ffffffffc02065c0 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	3fc60613          	addi	a2,a2,1020 # ffffffffc0205828 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	e6050513          	addi	a0,a0,-416 # ffffffffc0206298 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	1a850513          	addi	a0,a0,424 # ffffffffc0206610 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	1b250513          	addi	a0,a0,434 # ffffffffc0206650 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	1b650513          	addi	a0,a0,438 # ffffffffc0206678 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	1c050513          	addi	a0,a0,448 # ffffffffc02066a0 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	1cc50513          	addi	a0,a0,460 # ffffffffc02066c8 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	18650513          	addi	a0,a0,390 # ffffffffc02066a0 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	11e50513          	addi	a0,a0,286 # ffffffffc0206650 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	15450513          	addi	a0,a0,340 # ffffffffc02066a0 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	0aa50513          	addi	a0,a0,170 # ffffffffc0206610 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	0f850513          	addi	a0,a0,248 # ffffffffc0206678 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	12e50513          	addi	a0,a0,302 # ffffffffc02066c8 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	09850513          	addi	a0,a0,152 # ffffffffc0206650 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	e6a68693          	addi	a3,a3,-406 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	22a60613          	addi	a2,a2,554 # ffffffffc0205828 <commands+0x738>
ffffffffc0203606:	05700593          	li	a1,87
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	02e50513          	addi	a0,a0,46 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	16268693          	addi	a3,a3,354 # ffffffffc0206778 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	20a60613          	addi	a2,a2,522 # ffffffffc0205828 <commands+0x738>
ffffffffc0203626:	07900593          	li	a1,121
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	00e50513          	addi	a0,a0,14 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	11a68693          	addi	a3,a3,282 # ffffffffc0206750 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	1ea60613          	addi	a2,a2,490 # ffffffffc0205828 <commands+0x738>
ffffffffc0203646:	07700593          	li	a1,119
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	fee50513          	addi	a0,a0,-18 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	0ea68693          	addi	a3,a3,234 # ffffffffc0206740 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	1ca60613          	addi	a2,a2,458 # ffffffffc0205828 <commands+0x738>
ffffffffc0203666:	07500593          	li	a1,117
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	fce50513          	addi	a0,a0,-50 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	0ba68693          	addi	a3,a3,186 # ffffffffc0206730 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	1aa60613          	addi	a2,a2,426 # ffffffffc0205828 <commands+0x738>
ffffffffc0203686:	07200593          	li	a1,114
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	fae50513          	addi	a0,a0,-82 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	08a68693          	addi	a3,a3,138 # ffffffffc0206720 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	18a60613          	addi	a2,a2,394 # ffffffffc0205828 <commands+0x738>
ffffffffc02036a6:	06f00593          	li	a1,111
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	f8e50513          	addi	a0,a0,-114 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	05a68693          	addi	a3,a3,90 # ffffffffc0206710 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	16a60613          	addi	a2,a2,362 # ffffffffc0205828 <commands+0x738>
ffffffffc02036c6:	06c00593          	li	a1,108
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	f6e50513          	addi	a0,a0,-146 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	02a68693          	addi	a3,a3,42 # ffffffffc0206700 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	14a60613          	addi	a2,a2,330 # ffffffffc0205828 <commands+0x738>
ffffffffc02036e6:	06900593          	li	a1,105
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	f4e50513          	addi	a0,a0,-178 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	ffa68693          	addi	a3,a3,-6 # ffffffffc02066f0 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	12a60613          	addi	a2,a2,298 # ffffffffc0205828 <commands+0x738>
ffffffffc0203706:	06600593          	li	a1,102
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	f2e50513          	addi	a0,a0,-210 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	fda68693          	addi	a3,a3,-38 # ffffffffc02066f0 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	10a60613          	addi	a2,a2,266 # ffffffffc0205828 <commands+0x738>
ffffffffc0203726:	06300593          	li	a1,99
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f0e50513          	addi	a0,a0,-242 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	d2a68693          	addi	a3,a3,-726 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	0ea60613          	addi	a2,a2,234 # ffffffffc0205828 <commands+0x738>
ffffffffc0203746:	06000593          	li	a1,96
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	eee50513          	addi	a0,a0,-274 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d0a68693          	addi	a3,a3,-758 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	0ca60613          	addi	a2,a2,202 # ffffffffc0205828 <commands+0x738>
ffffffffc0203766:	05d00593          	li	a1,93
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	ece50513          	addi	a0,a0,-306 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	cea68693          	addi	a3,a3,-790 # ffffffffc0206460 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	0aa60613          	addi	a2,a2,170 # ffffffffc0205828 <commands+0x738>
ffffffffc0203786:	05a00593          	li	a1,90
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	eae50513          	addi	a0,a0,-338 # ffffffffc0206638 <default_pmm_manager+0xa60>
...
ffffffffc020379e:	e60d                	bnez	a2,ffffffffc02037c8 <_fifo_swap_out_victim+0x32>
    return listelm->next;
ffffffffc02037a0:	671c                	ld	a5,8(a4)
    if (entry != head) {
...
ffffffffc02037cc:	fd068693          	addi	a3,a3,-48 # ffffffffc0206798 <default_pmm_manager+0xbc0>
ffffffffc02037d0:	00002617          	auipc	a2,0x2
ffffffffc02037d4:	05860613          	addi	a2,a2,88 # ffffffffc0205828 <commands+0x738>
ffffffffc02037d8:	04200593          	li	a1,66
ffffffffc02037dc:	00003517          	auipc	a0,0x3
ffffffffc02037e0:	e5c50513          	addi	a0,a0,-420 # ffffffffc0206638 <default_pmm_manager+0xa60>
ffffffffc02037e4:	c63fc0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(head != NULL);
ffffffffc02037e8:	00003697          	auipc	a3,0x3
ffffffffc02037ec:	fa068693          	addi	a3,a3,-96 # ffffffffc0206788 <default_pmm_manager+0xbb0>
ffffffffc02037f0:	00002617          	auipc	a2,0x2
ffffffffc02037f4:	03860613          	addi	a2,a2,56 # ffffffffc0205828 <commands+0x738>
ffffffffc02037f8:	04100593          	li	a1,65
ffffffffc02037fc:	00003517          	auipc	a0,0x3
ffffffffc0203800:	e3c50513          	addi	a0,a0,-452 # ffffffffc0206638 <default_pmm_manager+0xa60>
...
ffffffffc020380a:	cb91                	beqz	a5,ffffffffc020381e <_fifo_map_swappable+0x16>
    __list_add(elm, listelm->prev, listelm);
ffffffffc020380c:	6394                	ld	a3,0(a5)
ffffffffc020380e:	02860713          	addi	a4,a2,40
    prev->next = next->prev = elm;
ffffffffc0203812:	e398                	sd	a4,0(a5)
ffffffffc0203814:	e698                	sd	a4,8(a3)
}
ffffffffc0203816:	4501                	li	a0,0
    elm->next = next;
ffffffffc0203818:	fa1c                	sd	a5,48(a2)
    elm->prev = prev;
ffffffffc020381a:	f614                	sd	a3,40(a2)
ffffffffc020381c:	8082                	ret
{
ffffffffc020381e:	1141                	addi	sp,sp,-16
    assert(entry != NULL && head != NULL);
ffffffffc0203820:	00003697          	auipc	a3,0x3
ffffffffc0203824:	f8868693          	addi	a3,a3,-120 # ffffffffc02067a8 <default_pmm_manager+0xbd0>
ffffffffc0203828:	00002617          	auipc	a2,0x2
ffffffffc020382c:	00060613          	mv	a2,a2
ffffffffc0203830:	03200593          	li	a1,50
ffffffffc0203834:	00003517          	auipc	a0,0x3
ffffffffc0203838:	e0450513          	addi	a0,a0,-508 # ffffffffc0206638 <default_pmm_manager+0xa60>
{
...
ffffffffc0203848:	f9c68693          	addi	a3,a3,-100 # ffffffffc02067e0 <default_pmm_manager+0xc08>
ffffffffc020384c:	00002617          	auipc	a2,0x2
ffffffffc0203850:	fdc60613          	addi	a2,a2,-36 # ffffffffc0205828 <commands+0x738>
ffffffffc0203854:	07e00593          	li	a1,126
ffffffffc0203858:	00003517          	auipc	a0,0x3
ffffffffc020385c:	fa850513          	addi	a0,a0,-88 # ffffffffc0206800 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203990:	e8468693          	addi	a3,a3,-380 # ffffffffc0206810 <default_pmm_manager+0xc38>
ffffffffc0203994:	00002617          	auipc	a2,0x2
ffffffffc0203998:	e9460613          	addi	a2,a2,-364 # ffffffffc0205828 <commands+0x738>
ffffffffc020399c:	08500593          	li	a1,133
ffffffffc02039a0:	00003517          	auipc	a0,0x3
ffffffffc02039a4:	e6050513          	addi	a0,a0,-416 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc02039a8:	a9ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039ac:	00003697          	auipc	a3,0x3
ffffffffc02039b0:	ea468693          	addi	a3,a3,-348 # ffffffffc0206850 <default_pmm_manager+0xc78>
ffffffffc02039b4:	00002617          	auipc	a2,0x2
ffffffffc02039b8:	e7460613          	addi	a2,a2,-396 # ffffffffc0205828 <commands+0x738>
ffffffffc02039bc:	07d00593          	li	a1,125
ffffffffc02039c0:	00003517          	auipc	a0,0x3
ffffffffc02039c4:	e4050513          	addi	a0,a0,-448 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc02039c8:	a7ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039cc:	00003697          	auipc	a3,0x3
ffffffffc02039d0:	e6468693          	addi	a3,a3,-412 # ffffffffc0206830 <default_pmm_manager+0xc58>
ffffffffc02039d4:	00002617          	auipc	a2,0x2
ffffffffc02039d8:	e5460613          	addi	a2,a2,-428 # ffffffffc0205828 <commands+0x738>
ffffffffc02039dc:	07c00593          	li	a1,124
ffffffffc02039e0:	00003517          	auipc	a0,0x3
ffffffffc02039e4:	e2050513          	addi	a0,a0,-480 # ffffffffc0206800 <default_pmm_manager+0xc28>
...
ffffffffc0203a82:	8a268693          	addi	a3,a3,-1886 # ffffffffc0206320 <default_pmm_manager+0x748>
ffffffffc0203a86:	00002617          	auipc	a2,0x2
ffffffffc0203a8a:	da260613          	addi	a2,a2,-606 # ffffffffc0205828 <commands+0x738>
ffffffffc0203a8e:	0c900593          	li	a1,201
ffffffffc0203a92:	00003517          	auipc	a0,0x3
ffffffffc0203a96:	d6e50513          	addi	a0,a0,-658 # ffffffffc0206800 <default_pmm_manager+0xc28>
...
ffffffffc0203ad6:	84e68693          	addi	a3,a3,-1970 # ffffffffc0206320 <default_pmm_manager+0x748>
ffffffffc0203ada:	00002617          	auipc	a2,0x2
ffffffffc0203ade:	d4e60613          	addi	a2,a2,-690 # ffffffffc0205828 <commands+0x738>
ffffffffc0203ae2:	0cf00593          	li	a1,207
ffffffffc0203ae6:	00003517          	auipc	a0,0x3
ffffffffc0203aea:	d1a50513          	addi	a0,a0,-742 # ffffffffc0206800 <default_pmm_manager+0xc28>
...
ffffffffc0203baa:	dca50513          	addi	a0,a0,-566 # ffffffffc0206970 <default_pmm_manager+0xd98>
ffffffffc0203bae:	dd2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203bb2:	00003697          	auipc	a3,0x3
ffffffffc0203bb6:	de668693          	addi	a3,a3,-538 # ffffffffc0206998 <default_pmm_manager+0xdc0>
ffffffffc0203bba:	00002617          	auipc	a2,0x2
ffffffffc0203bbe:	c6e60613          	addi	a2,a2,-914 # ffffffffc0205828 <commands+0x738>
ffffffffc0203bc2:	0f100593          	li	a1,241
ffffffffc0203bc6:	00003517          	auipc	a0,0x3
ffffffffc0203bca:	c3a50513          	addi	a0,a0,-966 # ffffffffc0206800 <default_pmm_manager+0xc28>
...
ffffffffc0203bf8:	dbc50513          	addi	a0,a0,-580 # ffffffffc02069b0 <default_pmm_manager+0xdd8>
...
ffffffffc0203cd2:	29aa3a03          	ld	s4,666(s4) # ffffffffc0206f68 <nbase>
...
ffffffffc0203d8c:	ca050513          	addi	a0,a0,-864 # ffffffffc0206a28 <default_pmm_manager+0xe50>
...
ffffffffc0203da6:	ca650513          	addi	a0,a0,-858 # ffffffffc0206a48 <default_pmm_manager+0xe70>
}
...
ffffffffc0203dba:	ad268693          	addi	a3,a3,-1326 # ffffffffc0206888 <default_pmm_manager+0xcb0>
ffffffffc0203dbe:	00002617          	auipc	a2,0x2
ffffffffc0203dc2:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0205828 <commands+0x738>
ffffffffc0203dc6:	0d800593          	li	a1,216
ffffffffc0203dca:	00003517          	auipc	a0,0x3
ffffffffc0203dce:	a3650513          	addi	a0,a0,-1482 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203dd2:	e74fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dd6:	00003697          	auipc	a3,0x3
ffffffffc0203dda:	b3a68693          	addi	a3,a3,-1222 # ffffffffc0206910 <default_pmm_manager+0xd38>
ffffffffc0203dde:	00002617          	auipc	a2,0x2
ffffffffc0203de2:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0205828 <commands+0x738>
ffffffffc0203de6:	0e800593          	li	a1,232
ffffffffc0203dea:	00003517          	auipc	a0,0x3
ffffffffc0203dee:	a1650513          	addi	a0,a0,-1514 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203df2:	e54fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203df6:	00003697          	auipc	a3,0x3
ffffffffc0203dfa:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206940 <default_pmm_manager+0xd68>
ffffffffc0203dfe:	00002617          	auipc	a2,0x2
ffffffffc0203e02:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0205828 <commands+0x738>
ffffffffc0203e06:	0e900593          	li	a1,233
ffffffffc0203e0a:	00003517          	auipc	a0,0x3
ffffffffc0203e0e:	9f650513          	addi	a0,a0,-1546 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203e12:	e34fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e16:	00003697          	auipc	a3,0x3
ffffffffc0203e1a:	a5a68693          	addi	a3,a3,-1446 # ffffffffc0206870 <default_pmm_manager+0xc98>
ffffffffc0203e1e:	00002617          	auipc	a2,0x2
ffffffffc0203e22:	a0a60613          	addi	a2,a2,-1526 # ffffffffc0205828 <commands+0x738>
ffffffffc0203e26:	0d600593          	li	a1,214
ffffffffc0203e2a:	00003517          	auipc	a0,0x3
ffffffffc0203e2e:	9d650513          	addi	a0,a0,-1578 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203e32:	e14fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e36:	00003697          	auipc	a3,0x3
ffffffffc0203e3a:	aba68693          	addi	a3,a3,-1350 # ffffffffc02068f0 <default_pmm_manager+0xd18>
ffffffffc0203e3e:	00002617          	auipc	a2,0x2
ffffffffc0203e42:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0205828 <commands+0x738>
ffffffffc0203e46:	0e400593          	li	a1,228
ffffffffc0203e4a:	00003517          	auipc	a0,0x3
ffffffffc0203e4e:	9b650513          	addi	a0,a0,-1610 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203e52:	df4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e56:	00003697          	auipc	a3,0x3
ffffffffc0203e5a:	aaa68693          	addi	a3,a3,-1366 # ffffffffc0206900 <default_pmm_manager+0xd28>
ffffffffc0203e5e:	00002617          	auipc	a2,0x2
ffffffffc0203e62:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0205828 <commands+0x738>
ffffffffc0203e66:	0e600593          	li	a1,230
ffffffffc0203e6a:	00003517          	auipc	a0,0x3
ffffffffc0203e6e:	99650513          	addi	a0,a0,-1642 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203e72:	dd4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e76:	00003697          	auipc	a3,0x3
ffffffffc0203e7a:	a4a68693          	addi	a3,a3,-1462 # ffffffffc02068c0 <default_pmm_manager+0xce8>
ffffffffc0203e7e:	00002617          	auipc	a2,0x2
ffffffffc0203e82:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205828 <commands+0x738>
ffffffffc0203e86:	0de00593          	li	a1,222
ffffffffc0203e8a:	00003517          	auipc	a0,0x3
ffffffffc0203e8e:	97650513          	addi	a0,a0,-1674 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203e92:	db4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e96:	00003697          	auipc	a3,0x3
ffffffffc0203e9a:	a3a68693          	addi	a3,a3,-1478 # ffffffffc02068d0 <default_pmm_manager+0xcf8>
ffffffffc0203e9e:	00002617          	auipc	a2,0x2
ffffffffc0203ea2:	98a60613          	addi	a2,a2,-1654 # ffffffffc0205828 <commands+0x738>
ffffffffc0203ea6:	0e000593          	li	a1,224
ffffffffc0203eaa:	00003517          	auipc	a0,0x3
ffffffffc0203eae:	95650513          	addi	a0,a0,-1706 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203eb2:	d94fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203eb6:	00003697          	auipc	a3,0x3
ffffffffc0203eba:	a2a68693          	addi	a3,a3,-1494 # ffffffffc02068e0 <default_pmm_manager+0xd08>
ffffffffc0203ebe:	00002617          	auipc	a2,0x2
ffffffffc0203ec2:	96a60613          	addi	a2,a2,-1686 # ffffffffc0205828 <commands+0x738>
ffffffffc0203ec6:	0e200593          	li	a1,226
ffffffffc0203eca:	00003517          	auipc	a0,0x3
ffffffffc0203ece:	93650513          	addi	a0,a0,-1738 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203ed2:	d74fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ed6:	00003697          	auipc	a3,0x3
ffffffffc0203eda:	b8a68693          	addi	a3,a3,-1142 # ffffffffc0206a60 <default_pmm_manager+0xe88>
ffffffffc0203ede:	00002617          	auipc	a2,0x2
ffffffffc0203ee2:	94a60613          	addi	a2,a2,-1718 # ffffffffc0205828 <commands+0x738>
ffffffffc0203ee6:	10100593          	li	a1,257
ffffffffc0203eea:	00003517          	auipc	a0,0x3
ffffffffc0203eee:	91650513          	addi	a0,a0,-1770 # ffffffffc0206800 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203f02:	42268693          	addi	a3,a3,1058 # ffffffffc0206320 <default_pmm_manager+0x748>
ffffffffc0203f06:	00002617          	auipc	a2,0x2
ffffffffc0203f0a:	92260613          	addi	a2,a2,-1758 # ffffffffc0205828 <commands+0x738>
ffffffffc0203f0e:	10800593          	li	a1,264
ffffffffc0203f12:	00003517          	auipc	a0,0x3
ffffffffc0203f16:	8ee50513          	addi	a0,a0,-1810 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203f1a:	d2cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f1e:	00003697          	auipc	a3,0x3
ffffffffc0203f22:	ab268693          	addi	a3,a3,-1358 # ffffffffc02069d0 <default_pmm_manager+0xdf8>
ffffffffc0203f26:	00002617          	auipc	a2,0x2
ffffffffc0203f2a:	90260613          	addi	a2,a2,-1790 # ffffffffc0205828 <commands+0x738>
ffffffffc0203f2e:	10d00593          	li	a1,269
ffffffffc0203f32:	00003517          	auipc	a0,0x3
ffffffffc0203f36:	8ce50513          	addi	a0,a0,-1842 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203f3a:	d0cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f3e:	00003697          	auipc	a3,0x3
ffffffffc0203f42:	ab268693          	addi	a3,a3,-1358 # ffffffffc02069f0 <default_pmm_manager+0xe18>
ffffffffc0203f46:	00002617          	auipc	a2,0x2
ffffffffc0203f4a:	8e260613          	addi	a2,a2,-1822 # ffffffffc0205828 <commands+0x738>
ffffffffc0203f4e:	11700593          	li	a1,279
ffffffffc0203f52:	00003517          	auipc	a0,0x3
ffffffffc0203f56:	8ae50513          	addi	a0,a0,-1874 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203f5a:	cecfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f5e:	00002617          	auipc	a2,0x2
ffffffffc0203f62:	d8260613          	addi	a2,a2,-638 # ffffffffc0205ce0 <default_pmm_manager+0x108>
ffffffffc0203f66:	06200593          	li	a1,98
ffffffffc0203f6a:	00002517          	auipc	a0,0x2
ffffffffc0203f6e:	cce50513          	addi	a0,a0,-818 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc0203f72:	cd4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f76:	00002617          	auipc	a2,0x2
ffffffffc0203f7a:	c9a60613          	addi	a2,a2,-870 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0203f7e:	06900593          	li	a1,105
ffffffffc0203f82:	00002517          	auipc	a0,0x2
ffffffffc0203f86:	cb650513          	addi	a0,a0,-842 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc0203f8a:	cbcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f8e:	00003697          	auipc	a3,0x3
ffffffffc0203f92:	a7268693          	addi	a3,a3,-1422 # ffffffffc0206a00 <default_pmm_manager+0xe28>
ffffffffc0203f96:	00002617          	auipc	a2,0x2
ffffffffc0203f9a:	89260613          	addi	a2,a2,-1902 # ffffffffc0205828 <commands+0x738>
ffffffffc0203f9e:	12400593          	li	a1,292
ffffffffc0203fa2:	00003517          	auipc	a0,0x3
ffffffffc0203fa6:	85e50513          	addi	a0,a0,-1954 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203faa:	c9cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203fae:	00002697          	auipc	a3,0x2
ffffffffc0203fb2:	36268693          	addi	a3,a3,866 # ffffffffc0206310 <default_pmm_manager+0x738>
ffffffffc0203fb6:	00002617          	auipc	a2,0x2
ffffffffc0203fba:	87260613          	addi	a2,a2,-1934 # ffffffffc0205828 <commands+0x738>
ffffffffc0203fbe:	10500593          	li	a1,261
ffffffffc0203fc2:	00003517          	auipc	a0,0x3
ffffffffc0203fc6:	83e50513          	addi	a0,a0,-1986 # ffffffffc0206800 <default_pmm_manager+0xc28>
ffffffffc0203fca:	c7cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fce:	00002697          	auipc	a3,0x2
ffffffffc0203fd2:	31a68693          	addi	a3,a3,794 # ffffffffc02062e8 <default_pmm_manager+0x710>
ffffffffc0203fd6:	00002617          	auipc	a2,0x2
ffffffffc0203fda:	85260613          	addi	a2,a2,-1966 # ffffffffc0205828 <commands+0x738>
ffffffffc0203fde:	0c200593          	li	a1,194
ffffffffc0203fe2:	00003517          	auipc	a0,0x3
ffffffffc0203fe6:	81e50513          	addi	a0,a0,-2018 # ffffffffc0206800 <default_pmm_manager+0xc28>
...
ffffffffc0204090:	a3c50513          	addi	a0,a0,-1476 # ffffffffc0206ac8 <default_pmm_manager+0xef0>
...
ffffffffc02040a2:	9da50513          	addi	a0,a0,-1574 # ffffffffc0206a78 <default_pmm_manager+0xea0>
...
ffffffffc02040b2:	a4250513          	addi	a0,a0,-1470 # ffffffffc0206af0 <default_pmm_manager+0xf18>
...
ffffffffc02040c2:	9ea50513          	addi	a0,a0,-1558 # ffffffffc0206aa8 <default_pmm_manager+0xed0>
...
ffffffffc02040f4:	a2860613          	addi	a2,a2,-1496 # ffffffffc0206b18 <default_pmm_manager+0xf40>
ffffffffc02040f8:	45b5                	li	a1,13
ffffffffc02040fa:	00003517          	auipc	a0,0x3
ffffffffc02040fe:	a3e50513          	addi	a0,a0,-1474 # ffffffffc0206b38 <default_pmm_manager+0xf60>
...
ffffffffc020412e:	e3e73703          	ld	a4,-450(a4) # ffffffffc0206f68 <nbase>
...
ffffffffc0204168:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0206b50 <default_pmm_manager+0xf78>
ffffffffc020416c:	45d1                	li	a1,20
ffffffffc020416e:	00003517          	auipc	a0,0x3
ffffffffc0204172:	9ca50513          	addi	a0,a0,-1590 # ffffffffc0206b38 <default_pmm_manager+0xf60>
...
ffffffffc0204184:	a9060613          	addi	a2,a2,-1392 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0204188:	00002517          	auipc	a0,0x2
ffffffffc020418c:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205c38 <default_pmm_manager+0x60>
...
ffffffffc02041bc:	db073703          	ld	a4,-592(a4) # ffffffffc0206f68 <nbase>
...
ffffffffc02041f6:	95e60613          	addi	a2,a2,-1698 # ffffffffc0206b50 <default_pmm_manager+0xf78>
ffffffffc02041fa:	45e5                	li	a1,25
ffffffffc02041fc:	00003517          	auipc	a0,0x3
ffffffffc0204200:	93c50513          	addi	a0,a0,-1732 # ffffffffc0206b38 <default_pmm_manager+0xf60>
...
ffffffffc0204212:	a0260613          	addi	a2,a2,-1534 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc0204216:	00002517          	auipc	a0,0x2
ffffffffc020421a:	a2250513          	addi	a0,a0,-1502 # ffffffffc0205c38 <default_pmm_manager+0x60>
...
ffffffffc0204224:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204226:	3dc000ef          	jal	ra,ffffffffc0204602 <do_exit>
...
ffffffffc0204240:	31c7b783          	ld	a5,796(a5) # ffffffffc0215558 <boot_cr3>
ffffffffc0204244:	f55c                	sd	a5,168(a0)
        proc->state = PROC_UNINIT;
...
ffffffffc020424e:	4581                	li	a1,0
        proc->state = PROC_UNINIT;
ffffffffc0204250:	e11c                	sd	a5,0(a0)
        proc->runs = 0;
...
ffffffffc020426a:	3cf000ef          	jal	ra,ffffffffc0204e38 <memset>
        // 设置trapframe为空
        proc->tf = NULL;
        // 设置进程标志为0
        proc->flags = 0;
...
ffffffffc020426e:	463d                	li	a2,15
        proc->tf = NULL;
...
ffffffffc020427e:	3bb000ef          	jal	ra,ffffffffc0204e38 <memset>
    }
    return proc;
}
...
ffffffffc02042e8:	8b450513          	addi	a0,a0,-1868 # ffffffffc0206b98 <default_pmm_manager+0xfc0>
ffffffffc02042ec:	e95fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042f0:	00003517          	auipc	a0,0x3
ffffffffc02042f4:	8b850513          	addi	a0,a0,-1864 # ffffffffc0206ba8 <default_pmm_manager+0xfd0>
...
ffffffffc020430e:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204310:	00011917          	auipc	s2,0x11
ffffffffc0204314:	2a090913          	addi	s2,s2,672 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc020434c:	53c000ef          	jal	ra,ffffffffc0204888 <switch_to>
    if (flag) {
...
ffffffffc020437c:	e44e                	sd	s3,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020437e:	00011997          	auipc	s3,0x11
ffffffffc0204382:	24a98993          	addi	s3,s3,586 # ffffffffc02155c8 <nr_process>
ffffffffc0204386:	0009a703          	lw	a4,0(s3)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020438a:	f406                	sd	ra,40(sp)
ffffffffc020438c:	f022                	sd	s0,32(sp)
ffffffffc020438e:	ec26                	sd	s1,24(sp)
ffffffffc0204390:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204392:	6785                	lui	a5,0x1
ffffffffc0204394:	1cf75c63          	bge	a4,a5,ffffffffc020456c <do_fork+0x1f2>
ffffffffc0204398:	84ae                	mv	s1,a1
...
ffffffffc02043a2:	1c050a63          	beqz	a0,ffffffffc0204576 <do_fork+0x1fc>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043a6:	4509                	li	a0,2
ffffffffc02043a8:	e84fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043ac:	1a050b63          	beqz	a0,ffffffffc0204562 <do_fork+0x1e8>
    return page - pages + nbase;
...
ffffffffc02043c2:	baa53503          	ld	a0,-1110(a0) # ffffffffc0206f68 <nbase>
...
ffffffffc02043d6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043d8:	1ce7f163          	bgeu	a5,a4,ffffffffc020459a <do_fork+0x220>
    assert(current->mm == NULL);
ffffffffc02043dc:	00011797          	auipc	a5,0x11
ffffffffc02043e0:	1d47b783          	ld	a5,468(a5) # ffffffffc02155b0 <current>
ffffffffc02043e4:	779c                	ld	a5,40(a5)
ffffffffc02043e6:	00011717          	auipc	a4,0x11
ffffffffc02043ea:	19a73703          	ld	a4,410(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043ee:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043f0:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc02043f4:	18079363          	bnez	a5,ffffffffc020457a <do_fork+0x200>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043f8:	6789                	lui	a5,0x2
ffffffffc02043fa:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043fe:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204400:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204402:	0ad93023          	sd	a3,160(s2)
    *(proc->tf) = *tf;
ffffffffc0204406:	87b6                	mv	a5,a3
ffffffffc0204408:	12040893          	addi	a7,s0,288
ffffffffc020440c:	00063803          	ld	a6,0(a2)
ffffffffc0204410:	6608                	ld	a0,8(a2)
ffffffffc0204412:	6a0c                	ld	a1,16(a2)
ffffffffc0204414:	6e18                	ld	a4,24(a2)
ffffffffc0204416:	0107b023          	sd	a6,0(a5)
ffffffffc020441a:	e788                	sd	a0,8(a5)
ffffffffc020441c:	eb8c                	sd	a1,16(a5)
ffffffffc020441e:	ef98                	sd	a4,24(a5)
ffffffffc0204420:	02060613          	addi	a2,a2,32
ffffffffc0204424:	02078793          	addi	a5,a5,32
ffffffffc0204428:	ff1612e3          	bne	a2,a7,ffffffffc020440c <do_fork+0x92>
    proc->tf->gpr.a0 = 0;
ffffffffc020442c:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204430:	10048d63          	beqz	s1,ffffffffc020454a <do_fork+0x1d0>
    if (++ last_pid >= MAX_PID) {
...
ffffffffc020443c:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204440:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204442:	00000717          	auipc	a4,0x0
ffffffffc0204446:	e4a70713          	addi	a4,a4,-438 # ffffffffc020428c <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc020444a:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020444e:	02e93823          	sd	a4,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204452:	02d93c23          	sd	a3,56(s2)
    if (++ last_pid >= MAX_PID) {
ffffffffc0204456:	00a82023          	sw	a0,0(a6)
ffffffffc020445a:	6789                	lui	a5,0x2
ffffffffc020445c:	08f55063          	bge	a0,a5,ffffffffc02044dc <do_fork+0x162>
    if (last_pid >= next_safe) {
ffffffffc0204460:	00006317          	auipc	t1,0x6
ffffffffc0204464:	bfc30313          	addi	t1,t1,-1028 # ffffffffc020a05c <next_safe.0>
ffffffffc0204468:	00032783          	lw	a5,0(t1)
ffffffffc020446c:	00011417          	auipc	s0,0x11
ffffffffc0204470:	0bc40413          	addi	s0,s0,188 # ffffffffc0215528 <proc_list>
ffffffffc0204474:	06f55c63          	bge	a0,a5,ffffffffc02044ec <do_fork+0x172>
    nr_process++;  
ffffffffc0204478:	0009a783          	lw	a5,0(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020447c:	45a9                	li	a1,10
    proc->pid = get_pid();
ffffffffc020447e:	00a92223          	sw	a0,4(s2)
    nr_process++;  
ffffffffc0204482:	2785                	addiw	a5,a5,1
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204484:	2501                	sext.w	a0,a0
    nr_process++;  
ffffffffc0204486:	00f9a023          	sw	a5,0(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020448a:	52e000ef          	jal	ra,ffffffffc02049b8 <hash32>
...
ffffffffc020449e:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044a0:	651c                	ld	a5,8(a0)
ffffffffc02044a2:	0d890693          	addi	a3,s2,216
ffffffffc02044a6:	6418                	ld	a4,8(s0)
    prev->next = next->prev = elm;
ffffffffc02044a8:	e394                	sd	a3,0(a5)
ffffffffc02044aa:	e514                	sd	a3,8(a0)
    elm->next = next;
ffffffffc02044ac:	0ef93023          	sd	a5,224(s2)
    elm->prev = prev;
ffffffffc02044b0:	0ca93c23          	sd	a0,216(s2)
    list_add(&proc_list, &(proc->list_link)); 
ffffffffc02044b4:	0c890793          	addi	a5,s2,200
    prev->next = next->prev = elm;
ffffffffc02044b8:	e31c                	sd	a5,0(a4)
    wakeup_proc(proc); 
ffffffffc02044ba:	854a                	mv	a0,s2
    elm->next = next;
ffffffffc02044bc:	0ce93823          	sd	a4,208(s2)
    elm->prev = prev;
ffffffffc02044c0:	0c893423          	sd	s0,200(s2)
    prev->next = next->prev = elm;
ffffffffc02044c4:	e41c                	sd	a5,8(s0)
ffffffffc02044c6:	42c000ef          	jal	ra,ffffffffc02048f2 <wakeup_proc>
    ret = proc->pid;   
ffffffffc02044ca:	00492503          	lw	a0,4(s2)
}
ffffffffc02044ce:	70a2                	ld	ra,40(sp)
ffffffffc02044d0:	7402                	ld	s0,32(sp)
ffffffffc02044d2:	64e2                	ld	s1,24(sp)
ffffffffc02044d4:	6942                	ld	s2,16(sp)
ffffffffc02044d6:	69a2                	ld	s3,8(sp)
ffffffffc02044d8:	6145                	addi	sp,sp,48
ffffffffc02044da:	8082                	ret
        last_pid = 1;
ffffffffc02044dc:	4785                	li	a5,1
ffffffffc02044de:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044e2:	4505                	li	a0,1
ffffffffc02044e4:	00006317          	auipc	t1,0x6
ffffffffc02044e8:	b7830313          	addi	t1,t1,-1160 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044ec:	00011417          	auipc	s0,0x11
ffffffffc02044f0:	03c40413          	addi	s0,s0,60 # ffffffffc0215528 <proc_list>
ffffffffc02044f4:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044f8:	6789                	lui	a5,0x2
ffffffffc02044fa:	00f32023          	sw	a5,0(t1)
ffffffffc02044fe:	86aa                	mv	a3,a0
ffffffffc0204500:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204502:	6e89                	lui	t4,0x2
ffffffffc0204504:	048e0a63          	beq	t3,s0,ffffffffc0204558 <do_fork+0x1de>
ffffffffc0204508:	88ae                	mv	a7,a1
ffffffffc020450a:	87f2                	mv	a5,t3
ffffffffc020450c:	6609                	lui	a2,0x2
ffffffffc020450e:	a811                	j	ffffffffc0204522 <do_fork+0x1a8>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204510:	00e6d663          	bge	a3,a4,ffffffffc020451c <do_fork+0x1a2>
ffffffffc0204514:	00c75463          	bge	a4,a2,ffffffffc020451c <do_fork+0x1a2>
ffffffffc0204518:	863a                	mv	a2,a4
ffffffffc020451a:	4885                	li	a7,1
ffffffffc020451c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020451e:	00878d63          	beq	a5,s0,ffffffffc0204538 <do_fork+0x1be>
            if (proc->pid == last_pid) {
ffffffffc0204522:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204526:	fed715e3          	bne	a4,a3,ffffffffc0204510 <do_fork+0x196>
                if (++ last_pid >= next_safe) {
ffffffffc020452a:	2685                	addiw	a3,a3,1
ffffffffc020452c:	02c6d163          	bge	a3,a2,ffffffffc020454e <do_fork+0x1d4>
ffffffffc0204530:	679c                	ld	a5,8(a5)
ffffffffc0204532:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204534:	fe8797e3          	bne	a5,s0,ffffffffc0204522 <do_fork+0x1a8>
ffffffffc0204538:	c581                	beqz	a1,ffffffffc0204540 <do_fork+0x1c6>
ffffffffc020453a:	00d82023          	sw	a3,0(a6)
ffffffffc020453e:	8536                	mv	a0,a3
ffffffffc0204540:	f2088ce3          	beqz	a7,ffffffffc0204478 <do_fork+0xfe>
ffffffffc0204544:	00c32023          	sw	a2,0(t1)
ffffffffc0204548:	bf05                	j	ffffffffc0204478 <do_fork+0xfe>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020454a:	84b6                	mv	s1,a3
ffffffffc020454c:	b5e5                	j	ffffffffc0204434 <do_fork+0xba>
                    if (last_pid >= MAX_PID) {
ffffffffc020454e:	01d6c363          	blt	a3,t4,ffffffffc0204554 <do_fork+0x1da>
                        last_pid = 1;
ffffffffc0204552:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204554:	4585                	li	a1,1
ffffffffc0204556:	b77d                	j	ffffffffc0204504 <do_fork+0x18a>
ffffffffc0204558:	cd81                	beqz	a1,ffffffffc0204570 <do_fork+0x1f6>
ffffffffc020455a:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020455e:	8536                	mv	a0,a3
ffffffffc0204560:	bf21                	j	ffffffffc0204478 <do_fork+0xfe>
    kfree(proc);
ffffffffc0204562:	854a                	mv	a0,s2
ffffffffc0204564:	b9afd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc0204568:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020456a:	b795                	j	ffffffffc02044ce <do_fork+0x154>
    int ret = -E_NO_FREE_PROC;
ffffffffc020456c:	556d                	li	a0,-5
ffffffffc020456e:	b785                	j	ffffffffc02044ce <do_fork+0x154>
    return last_pid;
ffffffffc0204570:	00082503          	lw	a0,0(a6)
ffffffffc0204574:	b711                	j	ffffffffc0204478 <do_fork+0xfe>
    ret = -E_NO_MEM;
ffffffffc0204576:	5571                	li	a0,-4
    return ret;
ffffffffc0204578:	bf99                	j	ffffffffc02044ce <do_fork+0x154>
    assert(current->mm == NULL);
ffffffffc020457a:	00002697          	auipc	a3,0x2
ffffffffc020457e:	64e68693          	addi	a3,a3,1614 # ffffffffc0206bc8 <default_pmm_manager+0xff0>
ffffffffc0204582:	00001617          	auipc	a2,0x1
ffffffffc0204586:	2a660613          	addi	a2,a2,678 # ffffffffc0205828 <commands+0x738>
ffffffffc020458a:	11d00593          	li	a1,285
ffffffffc020458e:	00002517          	auipc	a0,0x2
ffffffffc0204592:	65250513          	addi	a0,a0,1618 # ffffffffc0206be0 <default_pmm_manager+0x1008>
ffffffffc0204596:	eb1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020459a:	00001617          	auipc	a2,0x1
ffffffffc020459e:	67660613          	addi	a2,a2,1654 # ffffffffc0205c10 <default_pmm_manager+0x38>
ffffffffc02045a2:	06900593          	li	a1,105
ffffffffc02045a6:	00001517          	auipc	a0,0x1
ffffffffc02045aa:	69250513          	addi	a0,a0,1682 # ffffffffc0205c38 <default_pmm_manager+0x60>
ffffffffc02045ae:	e99fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02045c8:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045ca:	06f000ef          	jal	ra,ffffffffc0204e38 <memset>
...
ffffffffc02045ea:	c3c78793          	addi	a5,a5,-964 # ffffffffc0204222 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045ee:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02045f0:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045f2:	d89ff0ef          	jal	ra,ffffffffc020437a <do_fork>
}
...
ffffffffc0204608:	5f460613          	addi	a2,a2,1524 # ffffffffc0206bf8 <default_pmm_manager+0x1020>
ffffffffc020460c:	18100593          	li	a1,385
ffffffffc0204610:	00002517          	auipc	a0,0x2
ffffffffc0204614:	5d050513          	addi	a0,a0,1488 # ffffffffc0206be0 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc0204618:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020461a:	e2dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020461e <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc020461e:	7179                	addi	sp,sp,-48
ffffffffc0204620:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0204622:	00011797          	auipc	a5,0x11
ffffffffc0204626:	f0678793          	addi	a5,a5,-250 # ffffffffc0215528 <proc_list>
ffffffffc020462a:	f406                	sd	ra,40(sp)
ffffffffc020462c:	f022                	sd	s0,32(sp)
ffffffffc020462e:	e84a                	sd	s2,16(sp)
ffffffffc0204630:	e44e                	sd	s3,8(sp)
ffffffffc0204632:	0000d497          	auipc	s1,0xd
ffffffffc0204636:	ee648493          	addi	s1,s1,-282 # ffffffffc0211518 <hash_list>
ffffffffc020463a:	e79c                	sd	a5,8(a5)
ffffffffc020463c:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc020463e:	00011717          	auipc	a4,0x11
ffffffffc0204642:	eda70713          	addi	a4,a4,-294 # ffffffffc0215518 <name.2>
ffffffffc0204646:	87a6                	mv	a5,s1
ffffffffc0204648:	e79c                	sd	a5,8(a5)
ffffffffc020464a:	e39c                	sd	a5,0(a5)
ffffffffc020464c:	07c1                	addi	a5,a5,16
ffffffffc020464e:	fef71de3          	bne	a4,a5,ffffffffc0204648 <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204652:	bd9ff0ef          	jal	ra,ffffffffc020422a <alloc_proc>
ffffffffc0204656:	00011917          	auipc	s2,0x11
ffffffffc020465a:	f6290913          	addi	s2,s2,-158 # ffffffffc02155b8 <idleproc>
ffffffffc020465e:	00a93023          	sd	a0,0(s2)
ffffffffc0204662:	18050d63          	beqz	a0,ffffffffc02047fc <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204666:	07000513          	li	a0,112
...
ffffffffc0204672:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204674:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204676:	7c2000ef          	jal	ra,ffffffffc0204e38 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc020467a:	00093503          	ld	a0,0(s2)
ffffffffc020467e:	85a2                	mv	a1,s0
ffffffffc0204680:	07000613          	li	a2,112
ffffffffc0204684:	03050513          	addi	a0,a0,48
ffffffffc0204688:	7da000ef          	jal	ra,ffffffffc0204e62 <memcmp>
ffffffffc020468c:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020468e:	453d                	li	a0,15
ffffffffc0204690:	9befd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204694:	463d                	li	a2,15
ffffffffc0204696:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204698:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020469a:	79e000ef          	jal	ra,ffffffffc0204e38 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc020469e:	00093503          	ld	a0,0(s2)
ffffffffc02046a2:	463d                	li	a2,15
ffffffffc02046a4:	85a2                	mv	a1,s0
ffffffffc02046a6:	0b450513          	addi	a0,a0,180
ffffffffc02046aa:	7b8000ef          	jal	ra,ffffffffc0204e62 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046ae:	00093783          	ld	a5,0(s2)
ffffffffc02046b2:	00011717          	auipc	a4,0x11
ffffffffc02046b6:	ea673703          	ld	a4,-346(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc02046ba:	77d4                	ld	a3,168(a5)
ffffffffc02046bc:	0ee68463          	beq	a3,a4,ffffffffc02047a4 <proc_init+0x186>
...
ffffffffc02046c2:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046c4:	00003717          	auipc	a4,0x3
ffffffffc02046c8:	93c70713          	addi	a4,a4,-1732 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046cc:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046d0:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02046d2:	4705                	li	a4,1
ffffffffc02046d4:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046d6:	4641                	li	a2,16
ffffffffc02046d8:	4581                	li	a1,0
ffffffffc02046da:	8522                	mv	a0,s0
ffffffffc02046dc:	75c000ef          	jal	ra,ffffffffc0204e38 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02046e0:	463d                	li	a2,15
ffffffffc02046e2:	00002597          	auipc	a1,0x2
ffffffffc02046e6:	55e58593          	addi	a1,a1,1374 # ffffffffc0206c40 <default_pmm_manager+0x1068>
ffffffffc02046ea:	8522                	mv	a0,s0
ffffffffc02046ec:	75e000ef          	jal	ra,ffffffffc0204e4a <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02046f0:	00011717          	auipc	a4,0x11
ffffffffc02046f4:	ed870713          	addi	a4,a4,-296 # ffffffffc02155c8 <nr_process>
ffffffffc02046f8:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02046fa:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02046fe:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204700:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204702:	00002597          	auipc	a1,0x2
ffffffffc0204706:	54658593          	addi	a1,a1,1350 # ffffffffc0206c48 <default_pmm_manager+0x1070>
ffffffffc020470a:	00000517          	auipc	a0,0x0
ffffffffc020470e:	b9050513          	addi	a0,a0,-1136 # ffffffffc020429a <init_main>
    nr_process ++;
ffffffffc0204712:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204714:	00011797          	auipc	a5,0x11
ffffffffc0204718:	e8d7be23          	sd	a3,-356(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020471c:	e97ff0ef          	jal	ra,ffffffffc02045b2 <kernel_thread>
ffffffffc0204720:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0204722:	0ea05963          	blez	a0,ffffffffc0204814 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204726:	6789                	lui	a5,0x2
ffffffffc0204728:	fff5071b          	addiw	a4,a0,-1
ffffffffc020472c:	17f9                	addi	a5,a5,-2
ffffffffc020472e:	2501                	sext.w	a0,a0
ffffffffc0204730:	02e7e363          	bltu	a5,a4,ffffffffc0204756 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204734:	45a9                	li	a1,10
ffffffffc0204736:	282000ef          	jal	ra,ffffffffc02049b8 <hash32>
ffffffffc020473a:	02051793          	slli	a5,a0,0x20
ffffffffc020473e:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204742:	96a6                	add	a3,a3,s1
ffffffffc0204744:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0204746:	a029                	j	ffffffffc0204750 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc0204748:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020474c:	0a870563          	beq	a4,s0,ffffffffc02047f6 <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204750:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204752:	fef69be3          	bne	a3,a5,ffffffffc0204748 <proc_init+0x12a>
    return NULL;
ffffffffc0204756:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204758:	0b478493          	addi	s1,a5,180
...
ffffffffc0204760:	00011417          	auipc	s0,0x11
ffffffffc0204764:	e6040413          	addi	s0,s0,-416 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204768:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020476a:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020476c:	6cc000ef          	jal	ra,ffffffffc0204e38 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204770:	463d                	li	a2,15
ffffffffc0204772:	00002597          	auipc	a1,0x2
ffffffffc0204776:	50658593          	addi	a1,a1,1286 # ffffffffc0206c78 <default_pmm_manager+0x10a0>
ffffffffc020477a:	8526                	mv	a0,s1
ffffffffc020477c:	6ce000ef          	jal	ra,ffffffffc0204e4a <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204780:	00093783          	ld	a5,0(s2)
ffffffffc0204784:	c7e1                	beqz	a5,ffffffffc020484c <proc_init+0x22e>
ffffffffc0204786:	43dc                	lw	a5,4(a5)
ffffffffc0204788:	e3f1                	bnez	a5,ffffffffc020484c <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020478a:	601c                	ld	a5,0(s0)
ffffffffc020478c:	c3c5                	beqz	a5,ffffffffc020482c <proc_init+0x20e>
ffffffffc020478e:	43d8                	lw	a4,4(a5)
ffffffffc0204790:	4785                	li	a5,1
ffffffffc0204792:	08f71d63          	bne	a4,a5,ffffffffc020482c <proc_init+0x20e>
}
ffffffffc0204796:	70a2                	ld	ra,40(sp)
ffffffffc0204798:	7402                	ld	s0,32(sp)
ffffffffc020479a:	64e2                	ld	s1,24(sp)
ffffffffc020479c:	6942                	ld	s2,16(sp)
ffffffffc020479e:	69a2                	ld	s3,8(sp)
ffffffffc02047a0:	6145                	addi	sp,sp,48
ffffffffc02047a2:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047a4:	73d8                	ld	a4,160(a5)
ffffffffc02047a6:	ff09                	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
ffffffffc02047a8:	f0099ce3          	bnez	s3,ffffffffc02046c0 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047ac:	6394                	ld	a3,0(a5)
ffffffffc02047ae:	577d                	li	a4,-1
ffffffffc02047b0:	1702                	slli	a4,a4,0x20
ffffffffc02047b2:	f0e697e3          	bne	a3,a4,ffffffffc02046c0 <proc_init+0xa2>
ffffffffc02047b6:	4798                	lw	a4,8(a5)
ffffffffc02047b8:	f00714e3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047bc:	6b98                	ld	a4,16(a5)
ffffffffc02047be:	f00711e3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
ffffffffc02047c2:	4f98                	lw	a4,24(a5)
ffffffffc02047c4:	2701                	sext.w	a4,a4
ffffffffc02047c6:	ee071de3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
ffffffffc02047ca:	7398                	ld	a4,32(a5)
ffffffffc02047cc:	ee071ae3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047d0:	7798                	ld	a4,40(a5)
ffffffffc02047d2:	ee0717e3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
ffffffffc02047d6:	0b07a703          	lw	a4,176(a5)
ffffffffc02047da:	8d59                	or	a0,a0,a4
ffffffffc02047dc:	0005071b          	sext.w	a4,a0
ffffffffc02047e0:	ee0710e3          	bnez	a4,ffffffffc02046c0 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047e4:	00002517          	auipc	a0,0x2
ffffffffc02047e8:	44450513          	addi	a0,a0,1092 # ffffffffc0206c28 <default_pmm_manager+0x1050>
ffffffffc02047ec:	995fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02047f0:	00093783          	ld	a5,0(s2)
ffffffffc02047f4:	b5f1                	j	ffffffffc02046c0 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02047f6:	f2878793          	addi	a5,a5,-216
ffffffffc02047fa:	bfb9                	j	ffffffffc0204758 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02047fc:	00002617          	auipc	a2,0x2
ffffffffc0204800:	41460613          	addi	a2,a2,1044 # ffffffffc0206c10 <default_pmm_manager+0x1038>
ffffffffc0204804:	19900593          	li	a1,409
ffffffffc0204808:	00002517          	auipc	a0,0x2
ffffffffc020480c:	3d850513          	addi	a0,a0,984 # ffffffffc0206be0 <default_pmm_manager+0x1008>
ffffffffc0204810:	c37fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204814:	00002617          	auipc	a2,0x2
ffffffffc0204818:	44460613          	addi	a2,a2,1092 # ffffffffc0206c58 <default_pmm_manager+0x1080>
ffffffffc020481c:	1b900593          	li	a1,441
ffffffffc0204820:	00002517          	auipc	a0,0x2
ffffffffc0204824:	3c050513          	addi	a0,a0,960 # ffffffffc0206be0 <default_pmm_manager+0x1008>
ffffffffc0204828:	c1ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020482c:	00002697          	auipc	a3,0x2
ffffffffc0204830:	47c68693          	addi	a3,a3,1148 # ffffffffc0206ca8 <default_pmm_manager+0x10d0>
ffffffffc0204834:	00001617          	auipc	a2,0x1
ffffffffc0204838:	ff460613          	addi	a2,a2,-12 # ffffffffc0205828 <commands+0x738>
ffffffffc020483c:	1c000593          	li	a1,448
ffffffffc0204840:	00002517          	auipc	a0,0x2
ffffffffc0204844:	3a050513          	addi	a0,a0,928 # ffffffffc0206be0 <default_pmm_manager+0x1008>
ffffffffc0204848:	bfffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020484c:	00002697          	auipc	a3,0x2
ffffffffc0204850:	43468693          	addi	a3,a3,1076 # ffffffffc0206c80 <default_pmm_manager+0x10a8>
ffffffffc0204854:	00001617          	auipc	a2,0x1
ffffffffc0204858:	fd460613          	addi	a2,a2,-44 # ffffffffc0205828 <commands+0x738>
ffffffffc020485c:	1bf00593          	li	a1,447
ffffffffc0204860:	00002517          	auipc	a0,0x2
ffffffffc0204864:	38050513          	addi	a0,a0,896 # ffffffffc0206be0 <default_pmm_manager+0x1008>
ffffffffc0204868:	bdffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020486c <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc020486c:	1141                	addi	sp,sp,-16
ffffffffc020486e:	e022                	sd	s0,0(sp)
ffffffffc0204870:	e406                	sd	ra,8(sp)
ffffffffc0204872:	00011417          	auipc	s0,0x11
ffffffffc0204876:	d3e40413          	addi	s0,s0,-706 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020487a:	6018                	ld	a4,0(s0)
ffffffffc020487c:	4f1c                	lw	a5,24(a4)
ffffffffc020487e:	2781                	sext.w	a5,a5
ffffffffc0204880:	dff5                	beqz	a5,ffffffffc020487c <cpu_idle+0x10>
            schedule();
ffffffffc0204882:	0a2000ef          	jal	ra,ffffffffc0204924 <schedule>
ffffffffc0204886:	bfd5                	j	ffffffffc020487a <cpu_idle+0xe>

ffffffffc0204888 <switch_to>:
.text
...
ffffffffc0204888:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020488c:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204890:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204892:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204894:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204898:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020489c:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048a0:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048a4:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048a8:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048ac:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048b0:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048b4:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048b8:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048bc:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02048c0:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02048c4:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02048c6:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02048c8:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02048cc:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048d0:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048d4:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048d8:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048dc:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048e0:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02048e4:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02048e8:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02048ec:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02048f0:	8082                	ret

ffffffffc02048f2 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02048f2:	411c                	lw	a5,0(a0)
ffffffffc02048f4:	4705                	li	a4,1
ffffffffc02048f6:	37f9                	addiw	a5,a5,-2
ffffffffc02048f8:	00f77563          	bgeu	a4,a5,ffffffffc0204902 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02048fc:	4789                	li	a5,2
ffffffffc02048fe:	c11c                	sw	a5,0(a0)
ffffffffc0204900:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204902:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204904:	00002697          	auipc	a3,0x2
ffffffffc0204908:	3cc68693          	addi	a3,a3,972 # ffffffffc0206cd0 <default_pmm_manager+0x10f8>
ffffffffc020490c:	00001617          	auipc	a2,0x1
ffffffffc0204910:	f1c60613          	addi	a2,a2,-228 # ffffffffc0205828 <commands+0x738>
ffffffffc0204914:	45a5                	li	a1,9
ffffffffc0204916:	00002517          	auipc	a0,0x2
ffffffffc020491a:	3fa50513          	addi	a0,a0,1018 # ffffffffc0206d10 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020491e:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204920:	b27fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204924 <schedule>:
}
...
ffffffffc0204930:	4401                	li	s0,0
ffffffffc0204932:	efbd                	bnez	a5,ffffffffc02049b0 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204934:	00011897          	auipc	a7,0x11
ffffffffc0204938:	c7c8b883          	ld	a7,-900(a7) # ffffffffc02155b0 <current>
ffffffffc020493c:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204940:	00011517          	auipc	a0,0x11
ffffffffc0204944:	c7853503          	ld	a0,-904(a0) # ffffffffc02155b8 <idleproc>
ffffffffc0204948:	04a88e63          	beq	a7,a0,ffffffffc02049a4 <schedule+0x80>
ffffffffc020494c:	0c888693          	addi	a3,a7,200
ffffffffc0204950:	00011617          	auipc	a2,0x11
ffffffffc0204954:	bd860613          	addi	a2,a2,-1064 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc0204958:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc020495c:	4809                	li	a6,2
ffffffffc020495e:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204960:	00c78863          	beq	a5,a2,ffffffffc0204970 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204964:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204968:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020496c:	03070163          	beq	a4,a6,ffffffffc020498e <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204970:	fef697e3          	bne	a3,a5,ffffffffc020495e <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204974:	ed89                	bnez	a1,ffffffffc020498e <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204976:	451c                	lw	a5,8(a0)
ffffffffc0204978:	2785                	addiw	a5,a5,1
ffffffffc020497a:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020497c:	00a88463          	beq	a7,a0,ffffffffc0204984 <schedule+0x60>
            proc_run(next);
ffffffffc0204980:	98dff0ef          	jal	ra,ffffffffc020430c <proc_run>
    if (flag) {
ffffffffc0204984:	e819                	bnez	s0,ffffffffc020499a <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204992:	fef712e3          	bne	a4,a5,ffffffffc0204976 <schedule+0x52>
ffffffffc0204996:	852e                	mv	a0,a1
ffffffffc0204998:	bff9                	j	ffffffffc0204976 <schedule+0x52>
}
ffffffffc020499a:	6402                	ld	s0,0(sp)
ffffffffc020499c:	60a2                	ld	ra,8(sp)
ffffffffc020499e:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049a0:	c1dfb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049a4:	00011617          	auipc	a2,0x11
ffffffffc02049a8:	b8460613          	addi	a2,a2,-1148 # ffffffffc0215528 <proc_list>
ffffffffc02049ac:	86b2                	mv	a3,a2
ffffffffc02049ae:	b76d                	j	ffffffffc0204958 <schedule+0x34>
        intr_disable();
ffffffffc02049b0:	c13fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049b4:	4405                	li	s0,1
ffffffffc02049b6:	bfbd                	j	ffffffffc0204934 <schedule+0x10>

ffffffffc02049b8 <hash32>:
 *
...
ffffffffc02049b8:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049bc:	2785                	addiw	a5,a5,1
ffffffffc02049be:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049c2:	02000793          	li	a5,32
ffffffffc02049c6:	9f8d                	subw	a5,a5,a1
}
ffffffffc02049c8:	00f5553b          	srlw	a0,a0,a5
ffffffffc02049cc:	8082                	ret

ffffffffc02049ce <printnum>:
 * */
static void
...
ffffffffc02049ce:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049d2:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049d4:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049d8:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049da:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049de:	f022                	sd	s0,32(sp)
ffffffffc02049e0:	ec26                	sd	s1,24(sp)
ffffffffc02049e2:	e84a                	sd	s2,16(sp)
ffffffffc02049e4:	f406                	sd	ra,40(sp)
ffffffffc02049e6:	e44e                	sd	s3,8(sp)
ffffffffc02049e8:	84aa                	mv	s1,a0
ffffffffc02049ea:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc02049ec:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02049f0:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02049f2:	03067e63          	bgeu	a2,a6,ffffffffc0204a2e <printnum+0x60>
ffffffffc02049f6:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02049f8:	00805763          	blez	s0,ffffffffc0204a06 <printnum+0x38>
ffffffffc02049fc:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02049fe:	85ca                	mv	a1,s2
ffffffffc0204a00:	854e                	mv	a0,s3
ffffffffc0204a02:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a04:	fc65                	bnez	s0,ffffffffc02049fc <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a06:	1a02                	slli	s4,s4,0x20
ffffffffc0204a08:	00002797          	auipc	a5,0x2
ffffffffc0204a0c:	32078793          	addi	a5,a5,800 # ffffffffc0206d28 <default_pmm_manager+0x1150>
ffffffffc0204a10:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a14:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a16:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a18:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a1c:	70a2                	ld	ra,40(sp)
ffffffffc0204a1e:	69a2                	ld	s3,8(sp)
ffffffffc0204a20:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a22:	85ca                	mv	a1,s2
ffffffffc0204a24:	87a6                	mv	a5,s1
}
ffffffffc0204a26:	6942                	ld	s2,16(sp)
ffffffffc0204a28:	64e2                	ld	s1,24(sp)
ffffffffc0204a2a:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a2c:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a2e:	03065633          	divu	a2,a2,a6
ffffffffc0204a32:	8722                	mv	a4,s0
ffffffffc0204a34:	f9bff0ef          	jal	ra,ffffffffc02049ce <printnum>
ffffffffc0204a38:	b7f9                	j	ffffffffc0204a06 <printnum+0x38>

ffffffffc0204a3a <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a3a:	7119                	addi	sp,sp,-128
ffffffffc0204a3c:	f4a6                	sd	s1,104(sp)
ffffffffc0204a3e:	f0ca                	sd	s2,96(sp)
ffffffffc0204a40:	ecce                	sd	s3,88(sp)
ffffffffc0204a42:	e8d2                	sd	s4,80(sp)
ffffffffc0204a44:	e4d6                	sd	s5,72(sp)
ffffffffc0204a46:	e0da                	sd	s6,64(sp)
ffffffffc0204a48:	fc5e                	sd	s7,56(sp)
ffffffffc0204a4a:	f06a                	sd	s10,32(sp)
ffffffffc0204a4c:	fc86                	sd	ra,120(sp)
ffffffffc0204a4e:	f8a2                	sd	s0,112(sp)
ffffffffc0204a50:	f862                	sd	s8,48(sp)
ffffffffc0204a52:	f466                	sd	s9,40(sp)
ffffffffc0204a54:	ec6e                	sd	s11,24(sp)
ffffffffc0204a56:	892a                	mv	s2,a0
ffffffffc0204a58:	84ae                	mv	s1,a1
ffffffffc0204a5a:	8d32                	mv	s10,a2
ffffffffc0204a5c:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a5e:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc0204a64:	00002a97          	auipc	s5,0x2
ffffffffc0204a68:	2f0a8a93          	addi	s5,s5,752 # ffffffffc0206d54 <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204a6c:	00002b97          	auipc	s7,0x2
ffffffffc0204a70:	4c4b8b93          	addi	s7,s7,1220 # ffffffffc0206f30 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a74:	000d4503          	lbu	a0,0(s10)
ffffffffc0204a78:	001d0413          	addi	s0,s10,1
ffffffffc0204a7c:	01350a63          	beq	a0,s3,ffffffffc0204a90 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204a80:	c121                	beqz	a0,ffffffffc0204ac0 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204a82:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a84:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204a86:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a88:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204a8c:	ff351ae3          	bne	a0,s3,ffffffffc0204a80 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a90:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204a94:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204a98:	4c81                	li	s9,0
ffffffffc0204a9a:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204a9c:	5c7d                	li	s8,-1
ffffffffc0204a9e:	5dfd                	li	s11,-1
ffffffffc0204aa0:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204aa4:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aa6:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204aaa:	0ff5f593          	zext.b	a1,a1
ffffffffc0204aae:	00140d13          	addi	s10,s0,1
ffffffffc0204ab2:	04b56263          	bltu	a0,a1,ffffffffc0204af6 <vprintfmt+0xbc>
ffffffffc0204ab6:	058a                	slli	a1,a1,0x2
ffffffffc0204ab8:	95d6                	add	a1,a1,s5
ffffffffc0204aba:	4194                	lw	a3,0(a1)
ffffffffc0204abc:	96d6                	add	a3,a3,s5
ffffffffc0204abe:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204ac0:	70e6                	ld	ra,120(sp)
ffffffffc0204ac2:	7446                	ld	s0,112(sp)
ffffffffc0204ac4:	74a6                	ld	s1,104(sp)
ffffffffc0204ac6:	7906                	ld	s2,96(sp)
ffffffffc0204ac8:	69e6                	ld	s3,88(sp)
ffffffffc0204aca:	6a46                	ld	s4,80(sp)
ffffffffc0204acc:	6aa6                	ld	s5,72(sp)
ffffffffc0204ace:	6b06                	ld	s6,64(sp)
ffffffffc0204ad0:	7be2                	ld	s7,56(sp)
ffffffffc0204ad2:	7c42                	ld	s8,48(sp)
ffffffffc0204ad4:	7ca2                	ld	s9,40(sp)
ffffffffc0204ad6:	7d02                	ld	s10,32(sp)
ffffffffc0204ad8:	6de2                	ld	s11,24(sp)
ffffffffc0204ada:	6109                	addi	sp,sp,128
ffffffffc0204adc:	8082                	ret
            padc = '0';
ffffffffc0204ade:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204ae0:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae4:	846a                	mv	s0,s10
ffffffffc0204ae6:	00140d13          	addi	s10,s0,1
ffffffffc0204aea:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204aee:	0ff5f593          	zext.b	a1,a1
ffffffffc0204af2:	fcb572e3          	bgeu	a0,a1,ffffffffc0204ab6 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204af6:	85a6                	mv	a1,s1
ffffffffc0204af8:	02500513          	li	a0,37
ffffffffc0204afc:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204afe:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b02:	8d22                	mv	s10,s0
ffffffffc0204b04:	f73788e3          	beq	a5,s3,ffffffffc0204a74 <vprintfmt+0x3a>
ffffffffc0204b08:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b0c:	1d7d                	addi	s10,s10,-1
ffffffffc0204b0e:	ff379de3          	bne	a5,s3,ffffffffc0204b08 <vprintfmt+0xce>
ffffffffc0204b12:	b78d                	j	ffffffffc0204a74 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b14:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b18:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b1c:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b1e:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b22:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b26:	02d86463          	bltu	a6,a3,ffffffffc0204b4e <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b2a:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b2e:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b32:	0186873b          	addw	a4,a3,s8
ffffffffc0204b36:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b3a:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b3c:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b40:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b42:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b46:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b4a:	fed870e3          	bgeu	a6,a3,ffffffffc0204b2a <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b4e:	f40ddce3          	bgez	s11,ffffffffc0204aa6 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b52:	8de2                	mv	s11,s8
ffffffffc0204b54:	5c7d                	li	s8,-1
ffffffffc0204b56:	bf81                	j	ffffffffc0204aa6 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b58:	fffdc693          	not	a3,s11
ffffffffc0204b5c:	96fd                	srai	a3,a3,0x3f
ffffffffc0204b5e:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b62:	00144603          	lbu	a2,1(s0)
ffffffffc0204b66:	2d81                	sext.w	s11,s11
ffffffffc0204b68:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b6a:	bf35                	j	ffffffffc0204aa6 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204b6c:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b70:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204b74:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b76:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204b78:	bfd9                	j	ffffffffc0204b4e <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204b7a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204b7c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204b80:	01174463          	blt	a4,a7,ffffffffc0204b88 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204b84:	1a088e63          	beqz	a7,ffffffffc0204d40 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204b88:	000a3603          	ld	a2,0(s4)
ffffffffc0204b8c:	46c1                	li	a3,16
ffffffffc0204b8e:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204b90:	2781                	sext.w	a5,a5
ffffffffc0204b92:	876e                	mv	a4,s11
ffffffffc0204b94:	85a6                	mv	a1,s1
ffffffffc0204b96:	854a                	mv	a0,s2
ffffffffc0204b98:	e37ff0ef          	jal	ra,ffffffffc02049ce <printnum>
            break;
ffffffffc0204b9c:	bde1                	j	ffffffffc0204a74 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204b9e:	000a2503          	lw	a0,0(s4)
ffffffffc0204ba2:	85a6                	mv	a1,s1
ffffffffc0204ba4:	0a21                	addi	s4,s4,8
ffffffffc0204ba6:	9902                	jalr	s2
            break;
ffffffffc0204ba8:	b5f1                	j	ffffffffc0204a74 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204baa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bac:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bb0:	01174463          	blt	a4,a7,ffffffffc0204bb8 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bb4:	18088163          	beqz	a7,ffffffffc0204d36 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bb8:	000a3603          	ld	a2,0(s4)
ffffffffc0204bbc:	46a9                	li	a3,10
ffffffffc0204bbe:	8a2e                	mv	s4,a1
ffffffffc0204bc0:	bfc1                	j	ffffffffc0204b90 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bc2:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204bc6:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bc8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bca:	bdf1                	j	ffffffffc0204aa6 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204bcc:	85a6                	mv	a1,s1
ffffffffc0204bce:	02500513          	li	a0,37
ffffffffc0204bd2:	9902                	jalr	s2
            break;
ffffffffc0204bd4:	b545                	j	ffffffffc0204a74 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bd6:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204bda:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bdc:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bde:	b5e1                	j	ffffffffc0204aa6 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204be0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204be2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204be6:	01174463          	blt	a4,a7,ffffffffc0204bee <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204bea:	14088163          	beqz	a7,ffffffffc0204d2c <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204bee:	000a3603          	ld	a2,0(s4)
ffffffffc0204bf2:	46a1                	li	a3,8
ffffffffc0204bf4:	8a2e                	mv	s4,a1
ffffffffc0204bf6:	bf69                	j	ffffffffc0204b90 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204bf8:	03000513          	li	a0,48
ffffffffc0204bfc:	85a6                	mv	a1,s1
ffffffffc0204bfe:	e03e                	sd	a5,0(sp)
ffffffffc0204c00:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c02:	85a6                	mv	a1,s1
ffffffffc0204c04:	07800513          	li	a0,120
ffffffffc0204c08:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c0a:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c0c:	6782                	ld	a5,0(sp)
ffffffffc0204c0e:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c10:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c14:	bfb5                	j	ffffffffc0204b90 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c16:	000a3403          	ld	s0,0(s4)
ffffffffc0204c1a:	008a0713          	addi	a4,s4,8
ffffffffc0204c1e:	e03a                	sd	a4,0(sp)
ffffffffc0204c20:	14040263          	beqz	s0,ffffffffc0204d64 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c24:	0fb05763          	blez	s11,ffffffffc0204d12 <vprintfmt+0x2d8>
ffffffffc0204c28:	02d00693          	li	a3,45
ffffffffc0204c2c:	0cd79163          	bne	a5,a3,ffffffffc0204cee <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c30:	00044783          	lbu	a5,0(s0)
ffffffffc0204c34:	0007851b          	sext.w	a0,a5
ffffffffc0204c38:	cf85                	beqz	a5,ffffffffc0204c70 <vprintfmt+0x236>
ffffffffc0204c3a:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c3e:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c42:	000c4563          	bltz	s8,ffffffffc0204c4c <vprintfmt+0x212>
ffffffffc0204c46:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c48:	036c0263          	beq	s8,s6,ffffffffc0204c6c <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c4c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c4e:	0e0c8e63          	beqz	s9,ffffffffc0204d4a <vprintfmt+0x310>
ffffffffc0204c52:	3781                	addiw	a5,a5,-32
ffffffffc0204c54:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d4a <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c58:	03f00513          	li	a0,63
ffffffffc0204c5c:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c5e:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c62:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c64:	0a05                	addi	s4,s4,1
ffffffffc0204c66:	0007851b          	sext.w	a0,a5
ffffffffc0204c6a:	ffe1                	bnez	a5,ffffffffc0204c42 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204c6c:	01b05963          	blez	s11,ffffffffc0204c7e <vprintfmt+0x244>
ffffffffc0204c70:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c72:	85a6                	mv	a1,s1
ffffffffc0204c74:	02000513          	li	a0,32
ffffffffc0204c78:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c7a:	fe0d9be3          	bnez	s11,ffffffffc0204c70 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c7e:	6a02                	ld	s4,0(sp)
ffffffffc0204c80:	bbd5                	j	ffffffffc0204a74 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c82:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c84:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204c88:	01174463          	blt	a4,a7,ffffffffc0204c90 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204c8c:	08088d63          	beqz	a7,ffffffffc0204d26 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204c90:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204c94:	0a044d63          	bltz	s0,ffffffffc0204d4e <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204c98:	8622                	mv	a2,s0
ffffffffc0204c9a:	8a66                	mv	s4,s9
ffffffffc0204c9c:	46a9                	li	a3,10
ffffffffc0204c9e:	bdcd                	j	ffffffffc0204b90 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204ca0:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204ca4:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204ca6:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204ca8:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204cac:	8fb5                	xor	a5,a5,a3
ffffffffc0204cae:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cb2:	02d74163          	blt	a4,a3,ffffffffc0204cd4 <vprintfmt+0x29a>
ffffffffc0204cb6:	00369793          	slli	a5,a3,0x3
ffffffffc0204cba:	97de                	add	a5,a5,s7
ffffffffc0204cbc:	639c                	ld	a5,0(a5)
ffffffffc0204cbe:	cb99                	beqz	a5,ffffffffc0204cd4 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204cc0:	86be                	mv	a3,a5
ffffffffc0204cc2:	00000617          	auipc	a2,0x0
ffffffffc0204cc6:	1ee60613          	addi	a2,a2,494 # ffffffffc0204eb0 <etext+0x2a>
ffffffffc0204cca:	85a6                	mv	a1,s1
ffffffffc0204ccc:	854a                	mv	a0,s2
ffffffffc0204cce:	0ce000ef          	jal	ra,ffffffffc0204d9c <printfmt>
ffffffffc0204cd2:	b34d                	j	ffffffffc0204a74 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204cd4:	00002617          	auipc	a2,0x2
ffffffffc0204cd8:	07460613          	addi	a2,a2,116 # ffffffffc0206d48 <default_pmm_manager+0x1170>
ffffffffc0204cdc:	85a6                	mv	a1,s1
ffffffffc0204cde:	854a                	mv	a0,s2
ffffffffc0204ce0:	0bc000ef          	jal	ra,ffffffffc0204d9c <printfmt>
ffffffffc0204ce4:	bb41                	j	ffffffffc0204a74 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204ce6:	00002417          	auipc	s0,0x2
ffffffffc0204cea:	05a40413          	addi	s0,s0,90 # ffffffffc0206d40 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204cee:	85e2                	mv	a1,s8
ffffffffc0204cf0:	8522                	mv	a0,s0
ffffffffc0204cf2:	e43e                	sd	a5,8(sp)
ffffffffc0204cf4:	0e2000ef          	jal	ra,ffffffffc0204dd6 <strnlen>
ffffffffc0204cf8:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204cfc:	01b05b63          	blez	s11,ffffffffc0204d12 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d00:	67a2                	ld	a5,8(sp)
ffffffffc0204d02:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d06:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d08:	85a6                	mv	a1,s1
ffffffffc0204d0a:	8552                	mv	a0,s4
ffffffffc0204d0c:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d0e:	fe0d9ce3          	bnez	s11,ffffffffc0204d06 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d12:	00044783          	lbu	a5,0(s0)
ffffffffc0204d16:	00140a13          	addi	s4,s0,1
ffffffffc0204d1a:	0007851b          	sext.w	a0,a5
ffffffffc0204d1e:	d3a5                	beqz	a5,ffffffffc0204c7e <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d20:	05e00413          	li	s0,94
ffffffffc0204d24:	bf39                	j	ffffffffc0204c42 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d26:	000a2403          	lw	s0,0(s4)
ffffffffc0204d2a:	b7ad                	j	ffffffffc0204c94 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d2c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d30:	46a1                	li	a3,8
ffffffffc0204d32:	8a2e                	mv	s4,a1
ffffffffc0204d34:	bdb1                	j	ffffffffc0204b90 <vprintfmt+0x156>
ffffffffc0204d36:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d3a:	46a9                	li	a3,10
ffffffffc0204d3c:	8a2e                	mv	s4,a1
ffffffffc0204d3e:	bd89                	j	ffffffffc0204b90 <vprintfmt+0x156>
ffffffffc0204d40:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d44:	46c1                	li	a3,16
ffffffffc0204d46:	8a2e                	mv	s4,a1
ffffffffc0204d48:	b5a1                	j	ffffffffc0204b90 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d4a:	9902                	jalr	s2
ffffffffc0204d4c:	bf09                	j	ffffffffc0204c5e <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d4e:	85a6                	mv	a1,s1
ffffffffc0204d50:	02d00513          	li	a0,45
ffffffffc0204d54:	e03e                	sd	a5,0(sp)
ffffffffc0204d56:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d58:	6782                	ld	a5,0(sp)
ffffffffc0204d5a:	8a66                	mv	s4,s9
ffffffffc0204d5c:	40800633          	neg	a2,s0
ffffffffc0204d60:	46a9                	li	a3,10
ffffffffc0204d62:	b53d                	j	ffffffffc0204b90 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204d64:	03b05163          	blez	s11,ffffffffc0204d86 <vprintfmt+0x34c>
ffffffffc0204d68:	02d00693          	li	a3,45
ffffffffc0204d6c:	f6d79de3          	bne	a5,a3,ffffffffc0204ce6 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204d70:	00002417          	auipc	s0,0x2
ffffffffc0204d74:	fd040413          	addi	s0,s0,-48 # ffffffffc0206d40 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d78:	02800793          	li	a5,40
ffffffffc0204d7c:	02800513          	li	a0,40
ffffffffc0204d80:	00140a13          	addi	s4,s0,1
ffffffffc0204d84:	bd6d                	j	ffffffffc0204c3e <vprintfmt+0x204>
ffffffffc0204d86:	00002a17          	auipc	s4,0x2
ffffffffc0204d8a:	fbba0a13          	addi	s4,s4,-69 # ffffffffc0206d41 <default_pmm_manager+0x1169>
ffffffffc0204d8e:	02800513          	li	a0,40
ffffffffc0204d92:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d96:	05e00413          	li	s0,94
ffffffffc0204d9a:	b565                	j	ffffffffc0204c42 <vprintfmt+0x208>

ffffffffc0204d9c <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d9c:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204d9e:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204da2:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204da4:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204da6:	ec06                	sd	ra,24(sp)
ffffffffc0204da8:	f83a                	sd	a4,48(sp)
ffffffffc0204daa:	fc3e                	sd	a5,56(sp)
ffffffffc0204dac:	e0c2                	sd	a6,64(sp)
ffffffffc0204dae:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204db0:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204db2:	c89ff0ef          	jal	ra,ffffffffc0204a3a <vprintfmt>
}
ffffffffc0204db6:	60e2                	ld	ra,24(sp)
ffffffffc0204db8:	6161                	addi	sp,sp,80
ffffffffc0204dba:	8082                	ret

ffffffffc0204dbc <strlen>:
...
strlen(const char *s) {
ffffffffc0204dc0:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204dc2:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204dc4:	cb81                	beqz	a5,ffffffffc0204dd4 <strlen+0x18>
        cnt ++;
ffffffffc0204dc6:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204dc8:	00a707b3          	add	a5,a4,a0
ffffffffc0204dcc:	0007c783          	lbu	a5,0(a5)
ffffffffc0204dd0:	fbfd                	bnez	a5,ffffffffc0204dc6 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204dd6:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dd8:	e589                	bnez	a1,ffffffffc0204de2 <strnlen+0xc>
ffffffffc0204dda:	a811                	j	ffffffffc0204dee <strnlen+0x18>
        cnt ++;
ffffffffc0204ddc:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dde:	00f58863          	beq	a1,a5,ffffffffc0204dee <strnlen+0x18>
ffffffffc0204de2:	00f50733          	add	a4,a0,a5
ffffffffc0204de6:	00074703          	lbu	a4,0(a4)
ffffffffc0204dea:	fb6d                	bnez	a4,ffffffffc0204ddc <strnlen+0x6>
ffffffffc0204dec:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204dee:	852e                	mv	a0,a1
ffffffffc0204df0:	8082                	ret

ffffffffc0204df2 <strcpy>:
char *
...
ffffffffc0204dfa:	0585                	addi	a1,a1,1
ffffffffc0204dfc:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e00:	fb75                	bnez	a4,ffffffffc0204df4 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e04:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e08:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e0c:	cb89                	beqz	a5,ffffffffc0204e1e <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e0e:	0505                	addi	a0,a0,1
ffffffffc0204e10:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e12:	fee789e3          	beq	a5,a4,ffffffffc0204e04 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e16:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e1a:	9d19                	subw	a0,a0,a4
ffffffffc0204e1c:	8082                	ret
ffffffffc0204e1e:	4501                	li	a0,0
ffffffffc0204e20:	bfed                	j	ffffffffc0204e1a <strcmp+0x16>

ffffffffc0204e22 <strchr>:
...
ffffffffc0204e26:	c799                	beqz	a5,ffffffffc0204e34 <strchr+0x12>
        if (*s == c) {
ffffffffc0204e28:	00f58763          	beq	a1,a5,ffffffffc0204e36 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e2c:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e30:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e32:	fbfd                	bnez	a5,ffffffffc0204e28 <strchr+0x6>
    }
    return NULL;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e62:	c205                	beqz	a2,ffffffffc0204e82 <memcmp+0x20>
ffffffffc0204e64:	962e                	add	a2,a2,a1
ffffffffc0204e66:	a019                	j	ffffffffc0204e6c <memcmp+0xa>
ffffffffc0204e68:	00c58d63          	beq	a1,a2,ffffffffc0204e82 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204e76:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204e78:	fee788e3          	beq	a5,a4,ffffffffc0204e68 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e7c:	40e7853b          	subw	a0,a5,a4
