...
ffffffffc020312e:	fbe78793          	addi	a5,a5,-66 # ffffffffc02110e8 <pra_list_head1>
     // 初始化当前指针curr_ptr指向pra_list_head1，表示当前页面替换位置为链表头
     // 将mm的私有成员指针指向pra_list_head1，用于后续的页面替换算法操作
...
ffffffffc020321c:	09900593          	li	a1,153
...
ffffffffc020323c:	0b000593          	li	a1,176
...
ffffffffc020325c:	0ae00593          	li	a1,174
...
ffffffffc020327c:	0ad00593          	li	a1,173
...
ffffffffc020329c:	0ab00593          	li	a1,171
...
ffffffffc02032bc:	0a900593          	li	a1,169
...
ffffffffc02033b6:	e04a                	sd	s2,0(sp)
     assert(head != NULL);
ffffffffc02033b8:	c6ad                	beqz	a3,ffffffffc0203422 <_clock_swap_out_victim+0x76>
     assert(in_tick==0);
ffffffffc02033ba:	e641                	bnez	a2,ffffffffc0203442 <_clock_swap_out_victim+0x96>
...
ffffffffc02033c8:	4701                	li	a4,0
        if (curr_ptr == head) {
ffffffffc02033ca:	00d40b63          	beq	s0,a3,ffffffffc02033e0 <_clock_swap_out_victim+0x34>
        if (!currpage->visited) {
ffffffffc02033ce:	fe043783          	ld	a5,-32(s0)
ffffffffc02033d2:	cf81                	beqz	a5,ffffffffc02033ea <_clock_swap_out_victim+0x3e>
            currpage->visited = 0; // 清除访问标志
ffffffffc02033d4:	fe043023          	sd	zero,-32(s0)
    return listelm->next;
ffffffffc02033d8:	6400                	ld	s0,8(s0)
    while (1) {
ffffffffc02033da:	4705                	li	a4,1
        if (curr_ptr == head) {
ffffffffc02033dc:	fed419e3          	bne	s0,a3,ffffffffc02033ce <_clock_swap_out_victim+0x22>
ffffffffc02033e0:	6400                	ld	s0,8(s0)
ffffffffc02033e2:	4705                	li	a4,1
        if (!currpage->visited) {
ffffffffc02033e4:	fe043783          	ld	a5,-32(s0)
ffffffffc02033e8:	f7f5                	bnez	a5,ffffffffc02033d4 <_clock_swap_out_victim+0x28>
ffffffffc02033ea:	c311                	beqz	a4,ffffffffc02033ee <_clock_swap_out_victim+0x42>
ffffffffc02033ec:	e080                	sd	s0,0(s1)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc02033ee:	85a2                	mv	a1,s0
ffffffffc02033f0:	00002517          	auipc	a0,0x2
ffffffffc02033f4:	7d850513          	addi	a0,a0,2008 # ffffffffc0205bc8 <default_pmm_manager+0xaa0>
...
ffffffffc0203404:	6798                	ld	a4,8(a5)
ffffffffc0203406:	4501                	li	a0,0
    return listelm->prev;
ffffffffc0203408:	631c                	ld	a5,0(a4)
            curr_ptr = list_next(curr_ptr);
ffffffffc020340a:	e098                	sd	a4,0(s1)
}
ffffffffc020340c:	64a2                	ld	s1,8(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc020340e:	6398                	ld	a4,0(a5)
ffffffffc0203410:	679c                	ld	a5,8(a5)
    prev->next = next;
ffffffffc0203412:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203414:	e398                	sd	a4,0(a5)
            *ptr_page = currpage;
ffffffffc0203416:	00893023          	sd	s0,0(s2)
}
...
ffffffffc0203426:	78668693          	addi	a3,a3,1926 # ffffffffc0205ba8 <default_pmm_manager+0xa80>
...
ffffffffc0203446:	77668693          	addi	a3,a3,1910 # ffffffffc0205bb8 <default_pmm_manager+0xa90>
...
ffffffffc020346a:	cf89                	beqz	a5,ffffffffc0203484 <_clock_map_swappable+0x22>
    list_entry_t *head1 = (list_entry_t*) mm->sm_priv;
ffffffffc020346c:	751c                	ld	a5,40(a0)
ffffffffc020346e:	03060713          	addi	a4,a2,48
}
...
ffffffffc020348a:	75268693          	addi	a3,a3,1874 # ffffffffc0205bd8 <default_pmm_manager+0xab0>
ffffffffc020348e:	00002617          	auipc	a2,0x2
ffffffffc0203492:	8ea60613          	addi	a2,a2,-1814 # ffffffffc0204d78 <commands+0x738>
ffffffffc0203496:	03600593          	li	a1,54
...
ffffffffc02034ae:	76e68693          	addi	a3,a3,1902 # ffffffffc0205c18 <default_pmm_manager+0xaf0>
...
ffffffffc02034c2:	77a50513          	addi	a0,a0,1914 # ffffffffc0205c38 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc02035f6:	65668693          	addi	a3,a3,1622 # ffffffffc0205c48 <default_pmm_manager+0xb20>
...
ffffffffc020360a:	63250513          	addi	a0,a0,1586 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc020360e:	d67fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203612:	00002697          	auipc	a3,0x2
ffffffffc0203616:	67668693          	addi	a3,a3,1654 # ffffffffc0205c88 <default_pmm_manager+0xb60>
...
ffffffffc020362a:	61250513          	addi	a0,a0,1554 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc020362e:	d47fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203632:	00002697          	auipc	a3,0x2
ffffffffc0203636:	63668693          	addi	a3,a3,1590 # ffffffffc0205c68 <default_pmm_manager+0xb40>
...
ffffffffc020364a:	5f250513          	addi	a0,a0,1522 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203714:	52850513          	addi	a0,a0,1320 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203768:	4d450513          	addi	a0,a0,1236 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203828:	58450513          	addi	a0,a0,1412 # ffffffffc0205da8 <default_pmm_manager+0xc80>
ffffffffc020382c:	88ffc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203830:	00002697          	auipc	a3,0x2
ffffffffc0203834:	5a068693          	addi	a3,a3,1440 # ffffffffc0205dd0 <default_pmm_manager+0xca8>
...
ffffffffc0203848:	3f450513          	addi	a0,a0,1012 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203886:	58e50513          	addi	a0,a0,1422 # ffffffffc0205e10 <default_pmm_manager+0xce8>
...
ffffffffc0203964:	87873703          	ld	a4,-1928(a4) # ffffffffc02061d8 <nbase>
...
ffffffffc02039c8:	49c50513          	addi	a0,a0,1180 # ffffffffc0205e60 <default_pmm_manager+0xd38>
...
ffffffffc02039f0:	49450513          	addi	a0,a0,1172 # ffffffffc0205e80 <default_pmm_manager+0xd58>
}
...
ffffffffc0203a04:	2c068693          	addi	a3,a3,704 # ffffffffc0205cc0 <default_pmm_manager+0xb98>
...
ffffffffc0203a18:	22450513          	addi	a0,a0,548 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203a1c:	959fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a20:	00002697          	auipc	a3,0x2
ffffffffc0203a24:	35868693          	addi	a3,a3,856 # ffffffffc0205d78 <default_pmm_manager+0xc50>
...
ffffffffc0203a38:	20450513          	addi	a0,a0,516 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203a3c:	939fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a40:	00002697          	auipc	a3,0x2
ffffffffc0203a44:	30868693          	addi	a3,a3,776 # ffffffffc0205d48 <default_pmm_manager+0xc20>
...
ffffffffc0203a58:	1e450513          	addi	a0,a0,484 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203a5c:	919fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a60:	00002697          	auipc	a3,0x2
ffffffffc0203a64:	24868693          	addi	a3,a3,584 # ffffffffc0205ca8 <default_pmm_manager+0xb80>
...
ffffffffc0203a78:	1c450513          	addi	a0,a0,452 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203a7c:	8f9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a80:	00002697          	auipc	a3,0x2
ffffffffc0203a84:	27868693          	addi	a3,a3,632 # ffffffffc0205cf8 <default_pmm_manager+0xbd0>
...
ffffffffc0203a98:	1a450513          	addi	a0,a0,420 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203a9c:	8d9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203aa0:	00002697          	auipc	a3,0x2
ffffffffc0203aa4:	26868693          	addi	a3,a3,616 # ffffffffc0205d08 <default_pmm_manager+0xbe0>
...
ffffffffc0203ab8:	18450513          	addi	a0,a0,388 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203abc:	8b9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ac0:	00002697          	auipc	a3,0x2
ffffffffc0203ac4:	25868693          	addi	a3,a3,600 # ffffffffc0205d18 <default_pmm_manager+0xbf0>
...
ffffffffc0203ad8:	16450513          	addi	a0,a0,356 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203adc:	899fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ae0:	00002697          	auipc	a3,0x2
ffffffffc0203ae4:	24868693          	addi	a3,a3,584 # ffffffffc0205d28 <default_pmm_manager+0xc00>
...
ffffffffc0203af8:	14450513          	addi	a0,a0,324 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203afc:	879fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b00:	00002697          	auipc	a3,0x2
ffffffffc0203b04:	23868693          	addi	a3,a3,568 # ffffffffc0205d38 <default_pmm_manager+0xc10>
...
ffffffffc0203b18:	12450513          	addi	a0,a0,292 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203b38:	10450513          	addi	a0,a0,260 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203b3c:	839fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b40:	00002697          	auipc	a3,0x2
ffffffffc0203b44:	35868693          	addi	a3,a3,856 # ffffffffc0205e98 <default_pmm_manager+0xd70>
...
ffffffffc0203b58:	0e450513          	addi	a0,a0,228 # ffffffffc0205c38 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
...
ffffffffc0203b80:	0bc50513          	addi	a0,a0,188 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203b84:	ff0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b88:	00002697          	auipc	a3,0x2
ffffffffc0203b8c:	2a868693          	addi	a3,a3,680 # ffffffffc0205e30 <default_pmm_manager+0xd08>
...
ffffffffc0203ba0:	09c50513          	addi	a0,a0,156 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203ba4:	fd0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba8:	00002697          	auipc	a3,0x2
ffffffffc0203bac:	2a868693          	addi	a3,a3,680 # ffffffffc0205e50 <default_pmm_manager+0xd28>
...
ffffffffc0203bc0:	07c50513          	addi	a0,a0,124 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203be4:	20868693          	addi	a3,a3,520 # ffffffffc0205de8 <default_pmm_manager+0xcc0>
...
ffffffffc0203bf8:	04450513          	addi	a0,a0,68 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203bfc:	f78fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c00:	00002697          	auipc	a3,0x2
ffffffffc0203c04:	1e868693          	addi	a3,a3,488 # ffffffffc0205de8 <default_pmm_manager+0xcc0>
...
ffffffffc0203c18:	02450513          	addi	a0,a0,36 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203c38:	00450513          	addi	a0,a0,4 # ffffffffc0205c38 <default_pmm_manager+0xb10>
ffffffffc0203c3c:	f38fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c40:	00002697          	auipc	a3,0x2
ffffffffc0203c44:	1a868693          	addi	a3,a3,424 # ffffffffc0205de8 <default_pmm_manager+0xcc0>
...
ffffffffc0203c58:	fe450513          	addi	a0,a0,-28 # ffffffffc0205c38 <default_pmm_manager+0xb10>
...
ffffffffc0203d00:	1e450513          	addi	a0,a0,484 # ffffffffc0205ee0 <default_pmm_manager+0xdb8>
...
ffffffffc0203d12:	1a250513          	addi	a0,a0,418 # ffffffffc0205eb0 <default_pmm_manager+0xd88>
...
ffffffffc0203d22:	1ea50513          	addi	a0,a0,490 # ffffffffc0205f08 <default_pmm_manager+0xde0>
...
ffffffffc0203d54:	1e060613          	addi	a2,a2,480 # ffffffffc0205f30 <default_pmm_manager+0xe08>
ffffffffc0203d58:	45b5                	li	a1,13
ffffffffc0203d5a:	00002517          	auipc	a0,0x2
ffffffffc0203d5e:	1f650513          	addi	a0,a0,502 # ffffffffc0205f50 <default_pmm_manager+0xe28>
...
ffffffffc0203d8e:	4465b583          	ld	a1,1094(a1) # ffffffffc02061d0 <error_string+0x38>
ffffffffc0203d92:	02b60633          	mul	a2,a2,a1
ffffffffc0203d96:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d9a:	00002797          	auipc	a5,0x2
ffffffffc0203d9e:	43e7b783          	ld	a5,1086(a5) # ffffffffc02061d8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203dd4:	19860613          	addi	a2,a2,408 # ffffffffc0205f68 <default_pmm_manager+0xe40>
ffffffffc0203dd8:	45d1                	li	a1,20
ffffffffc0203dda:	00002517          	auipc	a0,0x2
ffffffffc0203dde:	17650513          	addi	a0,a0,374 # ffffffffc0205f50 <default_pmm_manager+0xe28>
...
ffffffffc0203e28:	3ac5b583          	ld	a1,940(a1) # ffffffffc02061d0 <error_string+0x38>
ffffffffc0203e2c:	02b60633          	mul	a2,a2,a1
ffffffffc0203e30:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e34:	00002797          	auipc	a5,0x2
ffffffffc0203e38:	3a47b783          	ld	a5,932(a5) # ffffffffc02061d8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203e6e:	0fe60613          	addi	a2,a2,254 # ffffffffc0205f68 <default_pmm_manager+0xe40>
ffffffffc0203e72:	45e5                	li	a1,25
ffffffffc0203e74:	00002517          	auipc	a0,0x2
ffffffffc0203e78:	0dc50513          	addi	a0,a0,220 # ffffffffc0205f50 <default_pmm_manager+0xe28>
...
ffffffffc0203ed8:	0b478793          	addi	a5,a5,180 # ffffffffc0205f88 <default_pmm_manager+0xe60>
...
ffffffffc0203f34:	08ca8a93          	addi	s5,s5,140 # ffffffffc0205fbc <default_pmm_manager+0xe94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f3c:	260b8b93          	addi	s7,s7,608 # ffffffffc0206198 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
ffffffffc0204192:	e2a60613          	addi	a2,a2,-470 # ffffffffc0205fb8 <default_pmm_manager+0xe90>
...
ffffffffc02041a4:	e0860613          	addi	a2,a2,-504 # ffffffffc0205fa8 <default_pmm_manager+0xe80>
...
ffffffffc02041b6:	dee40413          	addi	s0,s0,-530 # ffffffffc0205fa0 <default_pmm_manager+0xe78>
...
ffffffffc0204240:	d6440413          	addi	s0,s0,-668 # ffffffffc0205fa0 <default_pmm_manager+0xe78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc0204256:	d4fa0a13          	addi	s4,s4,-689 # ffffffffc0205fa1 <default_pmm_manager+0xe79>
...
ffffffffc02042a2:	d1a50513          	addi	a0,a0,-742 # ffffffffc0205fb8 <default_pmm_manager+0xe90>
